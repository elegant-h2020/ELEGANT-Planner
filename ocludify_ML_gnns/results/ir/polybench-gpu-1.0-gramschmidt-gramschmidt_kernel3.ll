; ModuleID = './kernels/kernels/polybench-gpu-1.0-gramschmidt-gramschmidt_kernel3.cl'
source_filename = "./kernels/kernels/polybench-gpu-1.0-gramschmidt-gramschmidt_kernel3.cl"
...
define dso_local spir_kernel void @A(float* nocapture %a, float* nocapture %b, float* nocapture readonly %c, i32 %d, i32 %e, i32 %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
for.body.preheader.new:                           ; preds = %for.body.preheader
  %unroll_iter93 = and i64 %wide.trip.count83, 4294967294
  br label %for.body
...
for.cond19.preheader.unr-lcssa:                   ; preds = %for.body, %for.body.preheader
  ...
  br i1 %lcmp.mod92.not, label %for.cond19.preheader, label %for.body.epil
...
for.body.epil:                                    ; preds = %for.cond19.preheader.unr-lcssa
  ...
  %6 = load float, float* %arrayidx9.epil, align 4, !tbaa !8
  %7 = add nsw i64 %4, %2
  %arrayidx13.epil = getelementptr inbounds float, float* %a, i64 %7
  %8 = load float, float* %arrayidx13.epil, align 4, !tbaa !8
  %9 = tail call float @llvm.fmuladd.f32(float %6, float %8, float %.unr)
  store float %9, float* %arrayidx, align 4, !tbaa !8
...
for.body22.preheader:                             ; preds = %for.cond19.preheader
  ...
  %13 = load float, float* %arrayidx2686, align 4, !tbaa !8
  %arrayidx3587 = getelementptr inbounds float, float* %a, i64 %12
  %14 = load float, float* %arrayidx3587, align 4, !tbaa !8
  %neg88 = fneg float %13
  %15 = tail call float @llvm.fmuladd.f32(float %neg88, float %.lcssa, float %14)
  store float %15, float* %arrayidx3587, align 4, !tbaa !8
  %exitcond.not89 = icmp eq i32 %e, 1
  br i1 %exitcond.not89, label %if.end, label %for.body22.for.body22_crit_edge.preheader
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %21 = load float, float* %arrayidx9, align 4, !tbaa !8
  %22 = add nsw i64 %19, %2
  %arrayidx13 = getelementptr inbounds float, float* %a, i64 %22
  %23 = load float, float* %arrayidx13, align 4, !tbaa !8
  %24 = tail call float @llvm.fmuladd.f32(float %21, float %23, float %18)
  store float %24, float* %arrayidx, align 4, !tbaa !8
  ...
  %27 = load float, float* %arrayidx9.1, align 4, !tbaa !8
  %28 = add nsw i64 %25, %2
  %arrayidx13.1 = getelementptr inbounds float, float* %a, i64 %28
  %29 = load float, float* %arrayidx13.1, align 4, !tbaa !8
  %30 = tail call float @llvm.fmuladd.f32(float %27, float %29, float %24)
  store float %30, float* %arrayidx, align 4, !tbaa !8
