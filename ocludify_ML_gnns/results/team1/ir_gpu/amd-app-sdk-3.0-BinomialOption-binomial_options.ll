; ModuleID = './kernels/kernels/amd-app-sdk-3.0-BinomialOption-binomial_options.cl'
source_filename = "./kernels/kernels/amd-app-sdk-3.0-BinomialOption-binomial_options.cl"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc19.16.27025"

; Function Attrs: convergent norecurse nounwind uwtable
define dso_local spir_kernel void @A(i32 %a, <4 x float>* nocapture readonly %b, <4 x float>* nocapture %c, <4 x float>* nocapture %d, <4 x float>* nocapture %e) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !7 !kernel_arg_type_qual !8 {
entry:
  %call = tail call i64 @"?get_local_id@@$$J0YAKI@Z"(i32 0) #4
  %conv = trunc i64 %call to i32
  %call1 = tail call i64 @"?get_group_id@@$$J0YAKI@Z"(i32 0) #4
  %idxprom = and i64 %call1, 4294967295
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %b, i64 %idxprom
  %0 = load <4 x float>, <4 x float>* %arrayidx, align 16, !tbaa !9
  ...
  %div = fdiv float 1.000000e+00, %conv8, !fpmath !12
  %splat.splatinsert = insertelement <4 x float> undef, float %div, i32 0
  %splat.splat = shufflevector <4 x float> %splat.splatinsert, <4 x float> undef, <4 x i32> zeroinitializer
  %mul = fmul <4 x float> %splat.splat, %3
  %call9 = tail call <4 x float> @"?sqrt@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float> %mul) #4
  ...
  %call12 = tail call <4 x float> @"?exp@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float> %mul11) #4
  %div13 = fdiv <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, %call12, !fpmath !12
  %call14 = tail call <4 x float> @"?exp@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float> %mul10) #4
  %div15 = fdiv <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, %call14, !fpmath !12
  %sub16 = fsub <4 x float> %call12, %div15
  %sub17 = fsub <4 x float> %call14, %div15
  %div18 = fdiv <4 x float> %sub16, %sub17, !fpmath !12
  ...
  %call28 = tail call <4 x float> @"?exp@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float> %mul27) #4
  %neg30 = fneg <4 x float> %2
...
if.then:                                          ; preds = %for.body
  %14 = load <4 x float>, <4 x float>* %arrayidx33, align 16, !tbaa !9
  %15 = load <4 x float>, <4 x float>* %arrayidx66, align 16, !tbaa !9
  %mul67 = fmul <4 x float> %mul21, %15
  %16 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mul20, <4 x float> %14, <4 x float> %mul67)
  store <4 x float> %16, <4 x float>* %arrayidx69, align 16, !tbaa !9
  br label %if.end
...
; Function Attrs: convergent nounwind readnone
declare dso_local <4 x float> @"?sqrt@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float>) local_unnamed_addr #1

; Function Attrs: convergent nounwind readnone
declare dso_local <4 x float> @"?exp@@$$J0YAT?$__vector@M$03@__clang@@T12@@Z"(<4 x float>) local_unnamed_addr #1
...
attributes #0 = { convergent norecurse nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="128" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "uniform-work-group-size"="false" "unsafe-fp-math"="false" "use-soft-float"="false" }
