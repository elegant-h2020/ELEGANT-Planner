; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-ratt8_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-ratt8_kernel.cl"
...
entry:
  ...
  %16 = load float, float* %arrayidx53, align 4, !tbaa !8
  %17 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul81 = fmul float %16, %17
  %18 = load float, float* %arrayidx12, align 4, !tbaa !8
  %add86 = add i64 %call, 104
  %arrayidx87 = getelementptr inbounds float, float* %d, i64 %add86
  %19 = load float, float* %arrayidx87, align 4, !tbaa !8
  %mul88 = fmul float %18, %19
  %add90 = add i64 %call, 128
  %arrayidx91 = getelementptr inbounds float, float* %d, i64 %add90
  %20 = load float, float* %arrayidx91, align 4, !tbaa !8
  ...
  %div136 = fdiv float 1.000000e+00, %28, !fpmath !12
  %mul137 = fmul float %mul132, %div136
  %add139 = add i64 %call, 1240
  %arrayidx140 = getelementptr inbounds float, float* %b, i64 %add139
  %29 = load float, float* %arrayidx140, align 4, !tbaa !8
  %call141 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul137, float 0x4415AF1D80000000) #2
  ...
  %30 = load float, float* %arrayidx127, align 4, !tbaa !8
  %31 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul152 = fmul float %30, %31
  %32 = load float, float* %arrayidx109, align 4, !tbaa !8
  %add157 = add i64 %call, 160
  %arrayidx158 = getelementptr inbounds float, float* %d, i64 %add157
  %33 = load float, float* %arrayidx158, align 4, !tbaa !8
  %mul159 = fmul float %32, %33
  %div160 = fdiv float 1.000000e+00, %mul159, !fpmath !12
  %mul161 = fmul float %mul152, %div160
  %add163 = add i64 %call, 1248
  %arrayidx164 = getelementptr inbounds float, float* %b, i64 %add163
  %34 = load float, float* %arrayidx164, align 4, !tbaa !8
  %call165 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul161, float 0x4415AF1D80000000) #2
  ...
  %35 = load float, float* %arrayidx5, align 4, !tbaa !8
  %36 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul176 = fmul float %35, %36
  %37 = load float, float* %arrayidx12, align 4, !tbaa !8
  %38 = load float, float* %arrayidx158, align 4, !tbaa !8
  %mul183 = fmul float %37, %38
  %div184 = fdiv float 1.000000e+00, %mul183, !fpmath !12
  %mul185 = fmul float %mul176, %div184
  %add187 = add i64 %call, 1256
  %arrayidx188 = getelementptr inbounds float, float* %b, i64 %add187
  %39 = load float, float* %arrayidx188, align 4, !tbaa !8
  %call189 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul185, float 0x4415AF1D80000000) #2
  %mul190 = fmul float %39, %call189
  %arrayidx193 = getelementptr inbounds float, float* %c, i64 %add187
  store float %mul190, float* %arrayidx193, align 4, !tbaa !8
  %40 = load float, float* %arrayidx5, align 4, !tbaa !8
  %41 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul200 = fmul float %40, %41
  %add202 = add i64 %call, 88
  %arrayidx203 = getelementptr inbounds float, float* %d, i64 %add202
  %42 = load float, float* %arrayidx203, align 4, !tbaa !8
  ...
  %div208 = fdiv float 1.000000e+00, %mul207, !fpmath !12
  %mul209 = fmul float %mul200, %div208
  %add211 = add i64 %call, 1264
  %arrayidx212 = getelementptr inbounds float, float* %b, i64 %add211
  %44 = load float, float* %arrayidx212, align 4, !tbaa !8
  %call213 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul209, float 0x4415AF1D80000000) #2
  %mul214 = fmul float %44, %call213
  %arrayidx217 = getelementptr inbounds float, float* %c, i64 %add211
  store float %mul214, float* %arrayidx217, align 4, !tbaa !8
  %45 = load float, float* %arrayidx5, align 4, !tbaa !8
  %46 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul224 = fmul float %45, %46
  %add226 = add i64 %call, 72
  %arrayidx227 = getelementptr inbounds float, float* %d, i64 %add226
  %47 = load float, float* %arrayidx227, align 4, !tbaa !8
  %48 = load float, float* %arrayidx91, align 4, !tbaa !8
  %mul231 = fmul float %47, %48
  %div232 = fdiv float 1.000000e+00, %mul231, !fpmath !12
  %mul233 = fmul float %mul224, %div232
  %add235 = add i64 %call, 1272
  %arrayidx236 = getelementptr inbounds float, float* %b, i64 %add235
  %49 = load float, float* %arrayidx236, align 4, !tbaa !8
  %call237 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul233, float 0x4415AF1D80000000) #2
  %mul238 = fmul float %49, %call237
  %arrayidx241 = getelementptr inbounds float, float* %c, i64 %add235
  store float %mul238, float* %arrayidx241, align 4, !tbaa !8
  %50 = load float, float* %arrayidx12, align 4, !tbaa !8
  %51 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul248 = fmul float %50, %51
  %52 = load float, float* %arrayidx36, align 4, !tbaa !8
  %53 = load float, float* %arrayidx158, align 4, !tbaa !8
  %mul255 = fmul float %52, %53
  %div256 = fdiv float 1.000000e+00, %mul255, !fpmath !12
  %mul257 = fmul float %mul248, %div256
  %add259 = add i64 %call, 1280
  %arrayidx260 = getelementptr inbounds float, float* %b, i64 %add259
  %54 = load float, float* %arrayidx260, align 4, !tbaa !8
  %call261 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul257, float 0x4415AF1D80000000) #2
  %mul262 = fmul float %54, %call261
  %arrayidx265 = getelementptr inbounds float, float* %c, i64 %add259
  store float %mul262, float* %arrayidx265, align 4, !tbaa !8
  %55 = load float, float* %arrayidx53, align 4, !tbaa !8
  %56 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul272 = fmul float %55, %56
  %57 = load float, float* %arrayidx60, align 4, !tbaa !8
  %58 = load float, float* %arrayidx158, align 4, !tbaa !8
  %mul279 = fmul float %57, %58
  %div280 = fdiv float 1.000000e+00, %mul279, !fpmath !12
  %mul281 = fmul float %mul272, %div280
  %add283 = add i64 %call, 1288
  %arrayidx284 = getelementptr inbounds float, float* %b, i64 %add283
  %59 = load float, float* %arrayidx284, align 4, !tbaa !8
  %call285 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul281, float 0x4415AF1D80000000) #2
  %mul286 = fmul float %59, %call285
  %arrayidx289 = getelementptr inbounds float, float* %c, i64 %add283
  store float %mul286, float* %arrayidx289, align 4, !tbaa !8
  %60 = load float, float* %arrayidx60, align 4, !tbaa !8
  %61 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul296 = fmul float %60, %61
  %62 = load float, float* %arrayidx12, align 4, !tbaa !8
  %add301 = add i64 %call, 216
  %arrayidx302 = getelementptr inbounds float, float* %d, i64 %add301
  %63 = load float, float* %arrayidx302, align 4, !tbaa !8
  %mul303 = fmul float %62, %63
  %div304 = fdiv float 1.000000e+00, %mul303, !fpmath !12
  %mul305 = fmul float %mul296, %div304
  %add307 = add i64 %call, 1296
  %arrayidx308 = getelementptr inbounds float, float* %b, i64 %add307
  %64 = load float, float* %arrayidx308, align 4, !tbaa !8
  %call309 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul305, float 0x4415AF1D80000000) #2
  %mul310 = fmul float %64, %call309
  %arrayidx313 = getelementptr inbounds float, float* %c, i64 %add307
  store float %mul310, float* %arrayidx313, align 4, !tbaa !8
  %65 = load float, float* %arrayidx206, align 4, !tbaa !8
  %66 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul320 = fmul float %65, %66
  %67 = load float, float* %arrayidx87, align 4, !tbaa !8
  %68 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul327 = fmul float %67, %68
  %div328 = fdiv float 1.000000e+00, %mul327, !fpmath !12
  %mul329 = fmul float %mul320, %div328
  %add331 = add i64 %call, 1304
  %arrayidx332 = getelementptr inbounds float, float* %b, i64 %add331
  %69 = load float, float* %arrayidx332, align 4, !tbaa !8
  %call333 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul329, float 0x4415AF1D80000000) #2
  %mul334 = fmul float %69, %call333
  %arrayidx337 = getelementptr inbounds float, float* %c, i64 %add331
  store float %mul334, float* %arrayidx337, align 4, !tbaa !8
  %70 = load float, float* %arrayidx227, align 4, !tbaa !8
  %71 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul344 = fmul float %70, %71
  %72 = load float, float* %arrayidx127, align 4, !tbaa !8
  %add349 = add i64 %call, 224
  %arrayidx350 = getelementptr inbounds float, float* %d, i64 %add349
  %73 = load float, float* %arrayidx350, align 4, !tbaa !8
  %mul351 = fmul float %72, %73
  %div352 = fdiv float 1.000000e+00, %mul351, !fpmath !12
  ...
  %call357 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul353, float 0x4415AF1D80000000) #2
  %mul358 = fmul float %74, %call357
  %arrayidx361 = getelementptr inbounds float, float* %c, i64 %add355
  store float %mul358, float* %arrayidx361, align 4, !tbaa !8
  %add363 = add i64 %call, 80
  %arrayidx364 = getelementptr inbounds float, float* %d, i64 %add363
  %75 = load float, float* %arrayidx364, align 4, !tbaa !8
  ...
  %77 = load float, float* %arrayidx371, align 4, !tbaa !8
  %78 = load float, float* %arrayidx112, align 4, !tbaa !8
  %mul375 = fmul float %77, %78
  %div376 = fdiv float 1.000000e+00, %mul375, !fpmath !12
  %mul377 = fmul float %mul368, %div376
  %add379 = add i64 %call, 1320
  %arrayidx380 = getelementptr inbounds float, float* %b, i64 %add379
  %79 = load float, float* %arrayidx380, align 4, !tbaa !8
  %call381 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul377, float 0x4415AF1D80000000) #2
  %mul382 = fmul float %79, %call381
  %arrayidx385 = getelementptr inbounds float, float* %c, i64 %add379
  store float %mul382, float* %arrayidx385, align 4, !tbaa !8
  %80 = load float, float* %arrayidx364, align 4, !tbaa !8
  %81 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul392 = fmul float %80, %81
  %82 = load float, float* %arrayidx127, align 4, !tbaa !8
  %83 = load float, float* %arrayidx350, align 4, !tbaa !8
  %mul399 = fmul float %82, %83
  %div400 = fdiv float 1.000000e+00, %mul399, !fpmath !12
  %mul401 = fmul float %mul392, %div400
  %add403 = add i64 %call, 1328
  %arrayidx404 = getelementptr inbounds float, float* %b, i64 %add403
  %84 = load float, float* %arrayidx404, align 4, !tbaa !8
  %call405 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul401, float 0x4415AF1D80000000) #2
  %mul406 = fmul float %84, %call405
  %arrayidx409 = getelementptr inbounds float, float* %c, i64 %add403
  store float %mul406, float* %arrayidx409, align 4, !tbaa !8
  %85 = load float, float* %arrayidx203, align 4, !tbaa !8
  %86 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul416 = fmul float %85, %86
  %87 = load float, float* %arrayidx371, align 4, !tbaa !8
  %88 = load float, float* %arrayidx158, align 4, !tbaa !8
  %mul423 = fmul float %87, %88
  %div424 = fdiv float 1.000000e+00, %mul423, !fpmath !12
  %mul425 = fmul float %mul416, %div424
  %add427 = add i64 %call, 1336
  %arrayidx428 = getelementptr inbounds float, float* %b, i64 %add427
  %89 = load float, float* %arrayidx428, align 4, !tbaa !8
  %call429 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul425, float 0x4415AF1D80000000) #2
  %mul430 = fmul float %89, %call429
  %arrayidx433 = getelementptr inbounds float, float* %c, i64 %add427
  store float %mul430, float* %arrayidx433, align 4, !tbaa !8
  %90 = load float, float* %arrayidx203, align 4, !tbaa !8
  %91 = load float, float* %arrayidx106, align 4, !tbaa !8
  ...
  %92 = load float, float* %arrayidx444, align 4, !tbaa !8
  %div445 = fdiv float 1.000000e+00, %92, !fpmath !12
  %mul446 = fmul float %mul441, %div445
  %add448 = add i64 %call, 1344
  %arrayidx449 = getelementptr inbounds float, float* %b, i64 %add448
  %93 = load float, float* %arrayidx449, align 4, !tbaa !8
  %call450 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul446, float 0x4415AF1D80000000) #2
  %mul451 = fmul float %93, %call450
  %arrayidx454 = getelementptr inbounds float, float* %c, i64 %add448
  store float %mul451, float* %arrayidx454, align 4, !tbaa !8
  %94 = load float, float* %arrayidx127, align 4, !tbaa !8
  %95 = load float, float* %arrayidx135, align 4, !tbaa !8
  ...
  %div466 = fdiv float 1.000000e+00, %96, !fpmath !12
  %mul467 = fmul float %mul462, %div466
  %add469 = add i64 %call, 1352
  %arrayidx470 = getelementptr inbounds float, float* %b, i64 %add469
  %97 = load float, float* %arrayidx470, align 4, !tbaa !8
  %call471 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul467, float 0x4415AF1D80000000) #2
  %mul472 = fmul float %97, %call471
  %arrayidx475 = getelementptr inbounds float, float* %c, i64 %add469
  store float %mul472, float* %arrayidx475, align 4, !tbaa !8
  %98 = load float, float* %arrayidx127, align 4, !tbaa !8
  %99 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul482 = fmul float %98, %99
  %100 = load float, float* %arrayidx109, align 4, !tbaa !8
  %101 = load float, float* %arrayidx106, align 4, !tbaa !8
  %mul489 = fmul float %100, %101
  %div490 = fdiv float 1.000000e+00, %mul489, !fpmath !12
  %mul491 = fmul float %mul482, %div490
  %add493 = add i64 %call, 1360
  %arrayidx494 = getelementptr inbounds float, float* %b, i64 %add493
  %102 = load float, float* %arrayidx494, align 4, !tbaa !8
  %call495 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul491, float 0x4415AF1D80000000) #2
  %mul496 = fmul float %102, %call495
  %arrayidx499 = getelementptr inbounds float, float* %c, i64 %add493
  store float %mul496, float* %arrayidx499, align 4, !tbaa !8
  %103 = load float, float* %arrayidx5, align 4, !tbaa !8
  %104 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul506 = fmul float %103, %104
  %105 = load float, float* %arrayidx203, align 4, !tbaa !8
  %106 = load float, float* %arrayidx91, align 4, !tbaa !8
  %mul513 = fmul float %105, %106
  %div514 = fdiv float 1.000000e+00, %mul513, !fpmath !12
  %mul515 = fmul float %mul506, %div514
  %add517 = add i64 %call, 1368
  %arrayidx518 = getelementptr inbounds float, float* %b, i64 %add517
  %107 = load float, float* %arrayidx518, align 4, !tbaa !8
  ...
  %108 = load float, float* %arrayidx5, align 4, !tbaa !8
  %109 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul530 = fmul float %108, %109
  %110 = load float, float* %arrayidx127, align 4, !tbaa !8
  %111 = load float, float* %arrayidx302, align 4, !tbaa !8
  ...
  %112 = load float, float* %arrayidx542, align 4, !tbaa !8
  ...
  %113 = load float, float* %arrayidx53, align 4, !tbaa !8
  %114 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul554 = fmul float %113, %114
  %115 = load float, float* %arrayidx60, align 4, !tbaa !8
  %116 = load float, float* %arrayidx106, align 4, !tbaa !8
  ...
  %117 = load float, float* %arrayidx566, align 4, !tbaa !8
  ...
  %118 = load float, float* %arrayidx60, align 4, !tbaa !8
  %119 = load float, float* %arrayidx135, align 4, !tbaa !8
  %mul578 = fmul float %118, %119
  %120 = load float, float* %arrayidx53, align 4, !tbaa !8
  %121 = load float, float* %arrayidx465, align 4, !tbaa !8
  ...
  %122 = load float, float* %arrayidx590, align 4, !tbaa !8
