; ModuleID = './kernels/kernels/npb-3.3-CG-main_2.cl'
source_filename = "./kernels/kernels/npb-3.3-CG-main_2.cl"
...
define dso_local spir_kernel void @A(double* nocapture %a, double* nocapture %b, double* nocapture %c, double* nocapture %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  %call = tail call i64 @"?get_global_id@@$$J0YAKI@Z"(i32 0) #2
  %conv = trunc i64 %call to i32
  %cmp.not = icmp slt i32 %conv, %e
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx5 = getelementptr inbounds double, double* %c, i64 %idxprom
  store double 0.000000e+00, double* %arrayidx5, align 8, !tbaa !8
  %arrayidx7 = getelementptr inbounds double, double* %d, i64 %idxprom
  store double 0.000000e+00, double* %arrayidx7, align 8, !tbaa !8
  br label %cleanup
