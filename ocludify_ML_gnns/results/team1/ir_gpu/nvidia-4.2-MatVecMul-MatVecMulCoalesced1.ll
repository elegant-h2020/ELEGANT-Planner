; ModuleID = './kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced1.cl'
source_filename = "./kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced1.cl"
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %call19 = tail call i64 @"?get_local_size@@$$J0YAKI@Z"(i32 0) #4
...
if.then:                                          ; preds = %for.body23
  ...
  %4 = load float, float* %arrayidx35, align 4, !tbaa !8
  %arrayidx37 = getelementptr inbounds float, float* %f, i64 %conv29
  %5 = load float, float* %arrayidx37, align 4, !tbaa !8
  %add38 = fadd float %4, %5
  store float %add38, float* %arrayidx37, align 4, !tbaa !8
  br label %if.end
...
if.end49:                                         ; preds = %for.cond.cleanup22.if.end49_crit_edge, %if.then45
  ...
  tail call void @"?barrier@@$$J0YAXI@Z"(i32 1) #5
  %call51 = tail call i64 @"?get_num_groups@@$$J0YAKI@Z"(i32 0) #4
