; ModuleID = './kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced0.cl'
source_filename = "./kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced0.cl"
...
for.cond20.preheader:                             ; preds = %for.cond.cleanup7
  %call22 = tail call i64 @"?get_local_size@@$$J0YAKI@Z"(i32 0) #4
  %cmp2367.not = icmp eq i64 %call22, 0
  br i1 %cmp2367.not, label %for.cond.cleanup25, label %for.body26
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.body8
  ...
  %1 = load float, float* %arrayidx10, align 4, !tbaa !8
...
for.cond.cleanup25:                               ; preds = %for.body26, %for.cond20.preheader
  ...
  store float %k.0.lcssa, float* %arrayidx33, align 4, !tbaa !8
  br label %if.end
...
for.body26:                                       ; preds = %for.cond20.preheader, %for.body26
  ...
  %3 = load float, float* %arrayidx28, align 4, !tbaa !8
...
if.end:                                           ; preds = %for.cond.cleanup7.if.end_crit_edge, %for.cond.cleanup25
  ...
  tail call void @"?barrier@@$$J0YAXI@Z"(i32 1) #5
  %call35 = tail call i64 @"?get_num_groups@@$$J0YAKI@Z"(i32 0) #4
