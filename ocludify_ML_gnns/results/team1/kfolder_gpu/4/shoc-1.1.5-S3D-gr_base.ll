; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-gr_base.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-gr_base.cl"
...
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readonly %b, float* readonly %c, float* %d, float %e, float %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  ...
  store float %mul6, float* %arrayidx9, align 4, !tbaa !8
  ...
  store float %mul14, float* %arrayidx17, align 4, !tbaa !8
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %26 = load float, float* %arrayidx185, align 4, !tbaa !8
  %call186 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %26, float 0x3810000000000000) #2
  %mul187 = fmul float %mul181, %call186
  store float %mul187, float* %arrayidx185, align 4, !tbaa !8
...
; Function Attrs: convergent nounwind readnone
declare dso_local float @"?fmax@@$$J0YAMMM@Z"(float, float) local_unnamed_addr #1
