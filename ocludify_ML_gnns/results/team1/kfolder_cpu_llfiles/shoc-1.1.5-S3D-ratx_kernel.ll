; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-ratx_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-ratx_kernel.cl"
...
entry:
  ...
  %28 = load float, float* %arrayidx133, align 4, !tbaa !8
  %arrayidx136 = getelementptr inbounds float, float* %c, i64 %add.15
  %29 = load float, float* %arrayidx136, align 4, !tbaa !8
  %div = fdiv float 1.000000e+00, %29, !fpmath !12
  ...
  %call145 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul138, float 0x3810000000000000) #3
  %call146 = tail call float @"?log10@@$$J0YAMM@Z"(float %call145) #3
  %mul147 = fmul float %mul, 0xBF85C98820000000
  %call148 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul147) #3
  %mul151 = fmul float %mul, 0xBF42A91CA0000000
  %call152 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul151) #3
  ...
  %div154 = fdiv float 1.000000e+00, %mul, !fpmath !12
  %mul155 = fmul float %div154, -5.182000e+03
  %call156 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul155) #3
  %add157 = fadd float %call156, %30
  %call158 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add157, float 0x3810000000000000) #3
  %call159 = tail call float @"?log10@@$$J0YAMM@Z"(float %call158) #3
  ...
  %call182 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv181) #3
  %mul183 = fmul float %call182, %conv144
  %mul187 = fmul float %29, %mul183
  store float %mul187, float* %arrayidx136, align 4, !tbaa !8
  %arrayidx193 = getelementptr inbounds float, float* %d, i64 %add.15
  %34 = load float, float* %arrayidx193, align 4, !tbaa !8
  %mul194 = fmul float %mul183, %34
  store float %mul194, float* %arrayidx193, align 4, !tbaa !8
  %arrayidx200 = getelementptr inbounds float, float* %e, i64 %add.1
  %35 = load float, float* %arrayidx200, align 4, !tbaa !8
  %add202 = add i64 %call, 240
  %arrayidx203 = getelementptr inbounds float, float* %c, i64 %add202
  %36 = load float, float* %arrayidx203, align 4, !tbaa !8
  %div204 = fdiv float 1.000000e+00, %36, !fpmath !12
  ...
  %call213 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul206, float 0x3810000000000000) #3
  %call214 = tail call float @"?log10@@$$J0YAMM@Z"(float %call213) #3
  %mul216 = fmul float %mul, 0xBF74CAB880000000
  %call217 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul216) #3
  %mul220 = fmul float %mul, 0xBF454725E0000000
  %call221 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul220) #3
  ...
  %call225 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul224) #3
  %add226 = fadd float %call225, %37
  %call227 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add226, float 0x3810000000000000) #3
  %call228 = tail call float @"?log10@@$$J0YAMM@Z"(float %call227) #3
  ...
  %call251 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv250) #3
  %mul252 = fmul float %call251, %conv212
  %mul256 = fmul float %36, %mul252
  store float %mul256, float* %arrayidx203, align 4, !tbaa !8
  %arrayidx262 = getelementptr inbounds float, float* %d, i64 %add202
  %41 = load float, float* %arrayidx262, align 4, !tbaa !8
  %mul263 = fmul float %mul252, %41
  store float %mul263, float* %arrayidx262, align 4, !tbaa !8
  %arrayidx269 = getelementptr inbounds float, float* %e, i64 %add.2
  %42 = load float, float* %arrayidx269, align 4, !tbaa !8
  %add271 = add i64 %call, 304
  %arrayidx272 = getelementptr inbounds float, float* %c, i64 %add271
  %43 = load float, float* %arrayidx272, align 4, !tbaa !8
  %div273 = fdiv float 1.000000e+00, %43, !fpmath !12
  ...
  %call282 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul275, float 0x3810000000000000) #3
  %call283 = tail call float @"?log10@@$$J0YAMM@Z"(float %call282) #3
  %mul285 = fmul float %mul, 0xBF71485F00000000
  %call286 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul285) #3
  %mul289 = fmul float %mul, 0xBF43D5D9A0000000
  %call290 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul289) #3
  ...
  %call294 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul293) #3
  %add295 = fadd float %call294, %44
  %call296 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add295, float 0x3810000000000000) #3
  %call297 = tail call float @"?log10@@$$J0YAMM@Z"(float %call296) #3
  ...
  %call320 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv319) #3
  %mul321 = fmul float %call320, %conv281
  %mul325 = fmul float %43, %mul321
  store float %mul325, float* %arrayidx272, align 4, !tbaa !8
  %arrayidx331 = getelementptr inbounds float, float* %d, i64 %add271
  %48 = load float, float* %arrayidx331, align 4, !tbaa !8
  ...
  %49 = load float, float* %arrayidx338, align 4, !tbaa !8
  %add340 = add i64 %call, 320
  %arrayidx341 = getelementptr inbounds float, float* %c, i64 %add340
  %50 = load float, float* %arrayidx341, align 4, !tbaa !8
  %div342 = fdiv float 1.000000e+00, %50, !fpmath !12
  ...
  %call351 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul344, float 0x3810000000000000) #3
  %call352 = tail call float @"?log10@@$$J0YAMM@Z"(float %call351) #3
  %mul354 = fmul float %mul, 0xBF6E3A9180000000
  %call355 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul354) #3
  %mul358 = fmul float %mul, 0xBF37C9BBC0000000
  %call359 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul358) #3
  ...
  %call363 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul362) #3
  %add364 = fadd float %call363, %51
  %call365 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add364, float 0x3810000000000000) #3
  %call366 = tail call float @"?log10@@$$J0YAMM@Z"(float %call365) #3
  ...
  %call389 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv388) #3
  %mul390 = fmul float %call389, %conv350
  %mul394 = fmul float %50, %mul390
  store float %mul394, float* %arrayidx341, align 4, !tbaa !8
  %arrayidx400 = getelementptr inbounds float, float* %d, i64 %add340
  %55 = load float, float* %arrayidx400, align 4, !tbaa !8
  %mul401 = fmul float %mul390, %55
  store float %mul401, float* %arrayidx400, align 4, !tbaa !8
  %arrayidx407 = getelementptr inbounds float, float* %e, i64 %add.4
  %56 = load float, float* %arrayidx407, align 4, !tbaa !8
  %add409 = add i64 %call, 376
  %arrayidx410 = getelementptr inbounds float, float* %c, i64 %add409
  %57 = load float, float* %arrayidx410, align 4, !tbaa !8
  %div411 = fdiv float 1.000000e+00, %57, !fpmath !12
  ...
  %call420 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul413, float 0x3810000000000000) #3
  %call421 = tail call float @"?log10@@$$J0YAMM@Z"(float %call420) #3
  %mul423 = fmul float %mul, 0xBF8A41A420000000
  %call424 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul423) #3
  %mul427 = fmul float %mul, 0xBF406CD0E0000000
  %call428 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul427) #3
  ...
  %call432 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul431) #3
  %add433 = fadd float %call432, %58
  %call434 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add433, float 0x3810000000000000) #3
  %call435 = tail call float @"?log10@@$$J0YAMM@Z"(float %call434) #3
  ...
  %call458 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv457) #3
  %mul459 = fmul float %call458, %conv419
  %mul463 = fmul float %57, %mul459
  store float %mul463, float* %arrayidx410, align 4, !tbaa !8
  %arrayidx469 = getelementptr inbounds float, float* %d, i64 %add409
  %62 = load float, float* %arrayidx469, align 4, !tbaa !8
  %mul470 = fmul float %mul459, %62
  store float %mul470, float* %arrayidx469, align 4, !tbaa !8
  %arrayidx476 = getelementptr inbounds float, float* %e, i64 %add.5
  %63 = load float, float* %arrayidx476, align 4, !tbaa !8
  %add478 = add i64 %call, 440
  %arrayidx479 = getelementptr inbounds float, float* %c, i64 %add478
  %64 = load float, float* %arrayidx479, align 4, !tbaa !8
  %div480 = fdiv float 1.000000e+00, %64, !fpmath !12
  ...
  %call489 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul482, float 0x3810000000000000) #3
  %call490 = tail call float @"?log10@@$$J0YAMM@Z"(float %call489) #3
  %mul492 = fmul float %mul, 0xBF6DCA01E0000000
  %call493 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul492) #3
  %mul496 = fmul float %mul, 0xBF4ABA4200000000
  %call497 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul496) #3
  ...
  %call501 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul500) #3
  %add502 = fadd float %call501, %65
  %call503 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add502, float 0x3810000000000000) #3
  %call504 = tail call float @"?log10@@$$J0YAMM@Z"(float %call503) #3
  ...
  %call527 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv526) #3
  %mul528 = fmul float %call527, %conv488
  %mul532 = fmul float %64, %mul528
  store float %mul532, float* %arrayidx479, align 4, !tbaa !8
  %arrayidx538 = getelementptr inbounds float, float* %d, i64 %add478
  %69 = load float, float* %arrayidx538, align 4, !tbaa !8
  %mul539 = fmul float %mul528, %69
  store float %mul539, float* %arrayidx538, align 4, !tbaa !8
  %arrayidx545 = getelementptr inbounds float, float* %e, i64 %add.6
  %70 = load float, float* %arrayidx545, align 4, !tbaa !8
  %add547 = add i64 %call, 560
  %arrayidx548 = getelementptr inbounds float, float* %c, i64 %add547
  %71 = load float, float* %arrayidx548, align 4, !tbaa !8
  %div549 = fdiv float 1.000000e+00, %71, !fpmath !12
  ...
  %call558 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul551, float 0x3810000000000000) #3
  %call559 = tail call float @"?log10@@$$J0YAMM@Z"(float %call558) #3
  %mul565 = fmul float %mul, 0xBF45129A60000000
  %call566 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul565) #3
  ...
  %call570 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul569) #3
  %add571 = fadd float %call570, %72
  %call572 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add571, float 0x3810000000000000) #3
  %call573 = tail call float @"?log10@@$$J0YAMM@Z"(float %call572) #3
  ...
  %call596 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv595) #3
  %mul597 = fmul float %call596, %conv557
  %mul601 = fmul float %71, %mul597
  store float %mul601, float* %arrayidx548, align 4, !tbaa !8
  %arrayidx607 = getelementptr inbounds float, float* %d, i64 %add547
  %76 = load float, float* %arrayidx607, align 4, !tbaa !8
  %mul608 = fmul float %76, %mul597
  store float %mul608, float* %arrayidx607, align 4, !tbaa !8
  %arrayidx614 = getelementptr inbounds float, float* %e, i64 %add.7
  %77 = load float, float* %arrayidx614, align 4, !tbaa !8
  %add616 = add i64 %call, 616
  %arrayidx617 = getelementptr inbounds float, float* %c, i64 %add616
  %78 = load float, float* %arrayidx617, align 4, !tbaa !8
  %div618 = fdiv float 1.000000e+00, %78, !fpmath !12
  ...
  %call627 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul620, float 0x3810000000000000) #3
  %call628 = tail call float @"?log10@@$$J0YAMM@Z"(float %call627) #3
  %mul630 = fmul float %mul, 0xBF8BACF920000000
  %call631 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul630) #3
  %mul634 = fmul float %mul, 0xBF36489880000000
  %call635 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul634) #3
  ...
  %call639 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul638) #3
  %add640 = fadd float %call639, %79
  %call641 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add640, float 0x3810000000000000) #3
  %call642 = tail call float @"?log10@@$$J0YAMM@Z"(float %call641) #3
  ...
  %call665 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv664) #3
  %mul666 = fmul float %call665, %conv626
  %mul670 = fmul float %78, %mul666
  store float %mul670, float* %arrayidx617, align 4, !tbaa !8
  %arrayidx676 = getelementptr inbounds float, float* %d, i64 %add616
  %83 = load float, float* %arrayidx676, align 4, !tbaa !8
  %mul677 = fmul float %mul666, %83
  store float %mul677, float* %arrayidx676, align 4, !tbaa !8
  %arrayidx683 = getelementptr inbounds float, float* %e, i64 %add.8
  %84 = load float, float* %arrayidx683, align 4, !tbaa !8
  %add685 = add i64 %call, 704
  %arrayidx686 = getelementptr inbounds float, float* %c, i64 %add685
  %85 = load float, float* %arrayidx686, align 4, !tbaa !8
  %div687 = fdiv float 1.000000e+00, %85, !fpmath !12
  ...
  %call696 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul689, float 0x3810000000000000) #3
  %call697 = tail call float @"?log10@@$$J0YAMM@Z"(float %call696) #3
  %mul699 = fmul float %mul, 0xBFB393EE20000000
  %call700 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul699) #3
  %mul703 = fmul float %mul, 0xBF3F89BB80000000
  %call704 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul703) #3
  ...
  %call710 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add709, float 0x3810000000000000) #3
  %call711 = tail call float @"?log10@@$$J0YAMM@Z"(float %call710) #3
  ...
  %call734 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv733) #3
  %mul735 = fmul float %call734, %conv695
  %mul739 = fmul float %85, %mul735
  store float %mul739, float* %arrayidx686, align 4, !tbaa !8
  %arrayidx745 = getelementptr inbounds float, float* %d, i64 %add685
  %90 = load float, float* %arrayidx745, align 4, !tbaa !8
  %mul746 = fmul float %mul735, %90
  store float %mul746, float* %arrayidx745, align 4, !tbaa !8
  %arrayidx752 = getelementptr inbounds float, float* %e, i64 %add.9
  %91 = load float, float* %arrayidx752, align 4, !tbaa !8
  %add754 = add i64 %call, 736
  %arrayidx755 = getelementptr inbounds float, float* %c, i64 %add754
  %92 = load float, float* %arrayidx755, align 4, !tbaa !8
  %div756 = fdiv float 1.000000e+00, %92, !fpmath !12
  ...
  %call765 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul758, float 0x3810000000000000) #3
  %call766 = tail call float @"?log10@@$$J0YAMM@Z"(float %call765) #3
  %mul768 = fmul float %mul, 0xBF7B203640000000
  %call769 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul768) #3
  %mul772 = fmul float %mul, 0xBF4F9182C0000000
  %call773 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul772) #3
  ...
  %call777 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul776) #3
  %add778 = fadd float %call777, %93
  %call779 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add778, float 0x3810000000000000) #3
  %call780 = tail call float @"?log10@@$$J0YAMM@Z"(float %call779) #3
  ...
  %call803 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv802) #3
  %mul804 = fmul float %call803, %conv764
  %mul808 = fmul float %92, %mul804
  store float %mul808, float* %arrayidx755, align 4, !tbaa !8
  %arrayidx814 = getelementptr inbounds float, float* %d, i64 %add754
  %97 = load float, float* %arrayidx814, align 4, !tbaa !8
  ...
  %98 = load float, float* %arrayidx821, align 4, !tbaa !8
  %add823 = add i64 %call, 904
  %arrayidx824 = getelementptr inbounds float, float* %c, i64 %add823
  %99 = load float, float* %arrayidx824, align 4, !tbaa !8
  %div825 = fdiv float 1.000000e+00, %99, !fpmath !12
  ...
  store float %mul837, float* %arrayidx824, align 4, !tbaa !8
  %arrayidx843 = getelementptr inbounds float, float* %d, i64 %add823
  %100 = load float, float* %arrayidx843, align 4, !tbaa !8
  %mul844 = fmul float %100, %conv833
  store float %mul844, float* %arrayidx843, align 4, !tbaa !8
  %arrayidx850 = getelementptr inbounds float, float* %e, i64 %add.11
  %101 = load float, float* %arrayidx850, align 4, !tbaa !8
  %add852 = add i64 %call, 912
  %arrayidx853 = getelementptr inbounds float, float* %c, i64 %add852
  %102 = load float, float* %arrayidx853, align 4, !tbaa !8
  %div854 = fdiv float 1.000000e+00, %102, !fpmath !12
  ...
  %call863 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul856, float 0x3810000000000000) #3
  %call864 = tail call float @"?log10@@$$J0YAMM@Z"(float %call863) #3
  %mul866 = fmul float %mul, 0xBF285898C0000000
  %call867 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul866) #3
  %mul870 = fmul float %mul, 0xBFCDD08900000000
  %call871 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul870) #3
  ...
  %call875 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul874) #3
  %add876 = fadd float %call875, %103
  %call877 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add876, float 0x3810000000000000) #3
  %call878 = tail call float @"?log10@@$$J0YAMM@Z"(float %call877) #3
  ...
  %call901 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv900) #3
  %mul902 = fmul float %call901, %conv862
  %mul906 = fmul float %102, %mul902
  store float %mul906, float* %arrayidx853, align 4, !tbaa !8
  %arrayidx912 = getelementptr inbounds float, float* %d, i64 %add852
  %107 = load float, float* %arrayidx912, align 4, !tbaa !8
