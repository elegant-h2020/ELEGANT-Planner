; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-qssa2_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-qssa2_kernel.cl"
...
define dso_local spir_kernel void @A(float* %a, float* %b, float* readonly %c) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  ...
  %9 = load float, float* %arrayidx18, align 4, !tbaa !8
  %add20 = add i64 %call, 200
  %arrayidx21 = getelementptr inbounds float, float* %c, i64 %add20
  %10 = load float, float* %arrayidx21, align 4, !tbaa !8
  ...
  %12 = load float, float* %arrayidx24, align 4, !tbaa !8
  ...
  %14 = load float, float* %arrayidx27, align 4, !tbaa !8
  ...
  %16 = load float, float* %arrayidx30, align 4, !tbaa !8
  %add32 = add i64 %call, 112
  %arrayidx33 = getelementptr inbounds float, float* %c, i64 %add32
  %17 = load float, float* %arrayidx33, align 4, !tbaa !8
  ...
  %19 = load float, float* %arrayidx36, align 4, !tbaa !8
  ...
  %21 = load float, float* %arrayidx39, align 4, !tbaa !8
  ...
  %23 = load float, float* %arrayidx42, align 4, !tbaa !8
  ...
  %25 = load float, float* %arrayidx45, align 4, !tbaa !8
  %add47 = add i64 %call, 728
  %arrayidx48 = getelementptr inbounds float, float* %c, i64 %add47
  %26 = load float, float* %arrayidx48, align 4, !tbaa !8
  ...
  %28 = load float, float* %arrayidx51, align 4, !tbaa !8
  ...
  %30 = load float, float* %arrayidx54, align 4, !tbaa !8
  %add56 = add i64 %call, 544
  %arrayidx57 = getelementptr inbounds float, float* %c, i64 %add56
  %31 = load float, float* %arrayidx57, align 4, !tbaa !8
  ...
  %33 = load float, float* %arrayidx60, align 4, !tbaa !8
  ...
  %35 = load float, float* %arrayidx63, align 4, !tbaa !8
  ...
  %37 = load float, float* %arrayidx66, align 4, !tbaa !8
  %add68 = add i64 %call, 816
  %arrayidx69 = getelementptr inbounds float, float* %c, i64 %add68
  %38 = load float, float* %arrayidx69, align 4, !tbaa !8
  ...
  %40 = load float, float* %arrayidx72, align 4, !tbaa !8
  ...
  %42 = load float, float* %arrayidx75, align 4, !tbaa !8
  %add77 = add i64 %call, 456
  %arrayidx78 = getelementptr inbounds float, float* %c, i64 %add77
  %43 = load float, float* %arrayidx78, align 4, !tbaa !8
  ...
  %45 = load float, float* %arrayidx81, align 4, !tbaa !8
  %add83 = add i64 %call, 936
  %arrayidx84 = getelementptr inbounds float, float* %c, i64 %add83
  %46 = load float, float* %arrayidx84, align 4, !tbaa !8
