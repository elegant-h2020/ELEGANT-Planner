; ModuleID = './kernels/kernels/rodinia-3.1-backprop-bpnn_layerforward_ocl.cl'
source_filename = "./kernels/kernels/rodinia-3.1-backprop-bpnn_layerforward_ocl.cl"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc19.16.27025"

; Function Attrs: convergent norecurse nounwind uwtable
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readnone %b, float* nocapture %c, float* nocapture %d, float* nocapture %e, float* nocapture %f, i32 %g, i32 %h) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  %call = tail call i64 @"?get_group_id@@$$J0YAKI@Z"(i32 1) #3
  %conv = trunc i64 %call to i32
  %call1 = tail call i64 @"?get_local_id@@$$J0YAKI@Z"(i32 0) #3
  %conv2 = trunc i64 %call1 to i32
  %call3 = tail call i64 @"?get_local_id@@$$J0YAKI@Z"(i32 1) #3
...
if.end55:                                         ; preds = %entry.if.end_crit_edge, %if.then
  ...
  store float %mul31, float* %arrayidx24, align 4, !tbaa !8
  tail call void @"?barrier@@$$J0YAXI@Z"(i32 1) #4
  %8 = load float, float* %arrayidx24, align 4, !tbaa !8
  %add50 = fadd float %8, %8
  store float %add50, float* %arrayidx24, align 4, !tbaa !8
  tail call void @"?barrier@@$$J0YAXI@Z"(i32 1) #4
  %9 = and i32 %conv4, 1
...
if.then40.1:                                      ; preds = %if.end55
  ...
  %14 = load float, float* %arrayidx49.1, align 4, !tbaa !8
  %add50.1 = fadd float %13, %14
  store float %add50.1, float* %arrayidx24, align 4, !tbaa !8
  br label %if.end55.1
...
if.then40.2:                                      ; preds = %if.end55.1
  %16 = load float, float* %arrayidx24, align 4, !tbaa !8
  ...
  %17 = load float, float* %arrayidx49.2, align 4, !tbaa !8
  %add50.2 = fadd float %16, %17
  store float %add50.2, float* %arrayidx24, align 4, !tbaa !8
  br label %if.end55.2
...
if.then40.3:                                      ; preds = %if.end55.2
  %19 = load float, float* %arrayidx24, align 4, !tbaa !8
  ...
  %20 = load float, float* %arrayidx49.3, align 4, !tbaa !8
  %add50.3 = fadd float %19, %20
  store float %add50.3, float* %arrayidx24, align 4, !tbaa !8
  br label %if.end55.3
...
if.then40.4:                                      ; preds = %if.end55.3
  %22 = load float, float* %arrayidx24, align 4, !tbaa !8
  ...
  %23 = load float, float* %arrayidx49.4, align 4, !tbaa !8
  %add50.4 = fadd float %22, %23
  store float %add50.4, float* %arrayidx24, align 4, !tbaa !8
  br label %if.end55.4
