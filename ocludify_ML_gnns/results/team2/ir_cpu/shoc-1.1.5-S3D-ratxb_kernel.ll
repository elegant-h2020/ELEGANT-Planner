; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-ratxb_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-ratxb_kernel.cl"
...
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readonly %b, float* nocapture %c, float* nocapture %d, float* nocapture readonly %e, float %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  ...
  %43 = load float, float* %arrayidx4.3, align 4, !tbaa !8
  ...
  %55 = load float, float* %arrayidx265, align 4, !tbaa !8
  %mul266 = fmul float %55, %conv38
  %56 = load float, float* %arrayidx4.1, align 4, !tbaa !8
  %mul270 = fmul float %mul266, %56
  %mul274 = fmul float %56, %mul270
  store float %mul274, float* %arrayidx265, align 4, !tbaa !8
  %arrayidx280 = getelementptr inbounds float, float* %d, i64 %add.4
  %57 = load float, float* %arrayidx280, align 4, !tbaa !8
  %mul281 = fmul float %57, %conv38
  %58 = load float, float* %arrayidx4, align 4, !tbaa !8
  %mul285 = fmul float %mul281, %58
  store float %mul285, float* %arrayidx280, align 4, !tbaa !8
  %arrayidx291 = getelementptr inbounds float, float* %c, i64 %add.8
  %59 = load float, float* %arrayidx291, align 4, !tbaa !8
  %mul292 = fmul float %59, %conv67
  %60 = load float, float* %arrayidx4.1, align 4, !tbaa !8
  %mul296 = fmul float %mul292, %60
  %61 = load float, float* %arrayidx4.4, align 4, !tbaa !8
  %mul300 = fmul float %mul296, %61
  store float %mul300, float* %arrayidx291, align 4, !tbaa !8
  %arrayidx306 = getelementptr inbounds float, float* %d, i64 %add.8
  %62 = load float, float* %arrayidx306, align 4, !tbaa !8
  %mul307 = fmul float %62, %conv67
  %63 = load float, float* %arrayidx4.5, align 4, !tbaa !8
  %mul311 = fmul float %mul307, %63
  store float %mul311, float* %arrayidx306, align 4, !tbaa !8
  %arrayidx317 = getelementptr inbounds float, float* %c, i64 %add.9
  %64 = load float, float* %arrayidx317, align 4, !tbaa !8
  %mul318 = fmul float %64, %conv108
  %65 = load float, float* %arrayidx4.2, align 4, !tbaa !8
  %mul322 = fmul float %mul318, %65
  %66 = load float, float* %arrayidx4.1, align 4, !tbaa !8
  %mul326 = fmul float %mul322, %66
  store float %mul326, float* %arrayidx317, align 4, !tbaa !8
  %arrayidx332 = getelementptr inbounds float, float* %d, i64 %add.9
  %67 = load float, float* %arrayidx332, align 4, !tbaa !8
  %mul333 = fmul float %67, %conv108
  %68 = load float, float* %arrayidx4.4, align 4, !tbaa !8
  %mul337 = fmul float %mul333, %68
  store float %mul337, float* %arrayidx332, align 4, !tbaa !8
  %arrayidx343 = getelementptr inbounds float, float* %c, i64 %add.10
  %69 = load float, float* %arrayidx343, align 4, !tbaa !8
  %mul344 = fmul float %69, %conv145
  %70 = load float, float* %arrayidx4.2, align 4, !tbaa !8
  %mul348 = fmul float %mul344, %70
  %mul352 = fmul float %70, %mul348
  store float %mul352, float* %arrayidx343, align 4, !tbaa !8
  %arrayidx358 = getelementptr inbounds float, float* %d, i64 %add.10
  %71 = load float, float* %arrayidx358, align 4, !tbaa !8
  %mul359 = fmul float %71, %conv145
  %72 = load float, float* %arrayidx4.3, align 4, !tbaa !8
  %mul363 = fmul float %mul359, %72
  store float %mul363, float* %arrayidx358, align 4, !tbaa !8
  %arrayidx369 = getelementptr inbounds float, float* %c, i64 %add.11
  %73 = load float, float* %arrayidx369, align 4, !tbaa !8
  %mul370 = fmul float %73, %conv184
  %74 = load float, float* %arrayidx4.1, align 4, !tbaa !8
  %mul374 = fmul float %mul370, %74
  %75 = load float, float* %arrayidx4.3, align 4, !tbaa !8
  %mul378 = fmul float %mul374, %75
  store float %mul378, float* %arrayidx369, align 4, !tbaa !8
  %arrayidx384 = getelementptr inbounds float, float* %d, i64 %add.11
  %76 = load float, float* %arrayidx384, align 4, !tbaa !8
  %mul385 = fmul float %76, %conv184
  %77 = load float, float* %arrayidx4.6, align 4, !tbaa !8
  %mul389 = fmul float %mul385, %77
  store float %mul389, float* %arrayidx384, align 4, !tbaa !8
  %add394 = add i64 %call, 224
  %arrayidx395 = getelementptr inbounds float, float* %c, i64 %add394
  %78 = load float, float* %arrayidx395, align 4, !tbaa !8
  %mul396 = fmul float %78, %conv231
  %79 = load float, float* %arrayidx4.10, align 4, !tbaa !8
  %mul400 = fmul float %mul396, %79
  %80 = load float, float* %arrayidx4.2, align 4, !tbaa !8
  %mul404 = fmul float %mul400, %80
  store float %mul404, float* %arrayidx395, align 4, !tbaa !8
  %arrayidx410 = getelementptr inbounds float, float* %d, i64 %add394
  %81 = load float, float* %arrayidx410, align 4, !tbaa !8
  %mul411 = fmul float %81, %conv231
  %82 = load float, float* %arrayidx4.11, align 4, !tbaa !8
  %mul415 = fmul float %mul411, %82
  store float %mul415, float* %arrayidx410, align 4, !tbaa !8
  ...
  store float %mul422, float* %arrayidx421, align 4, !tbaa !8
  %arrayidx428 = getelementptr inbounds float, float* %d, i64 %add420
  %84 = load float, float* %arrayidx428, align 4, !tbaa !8
  %mul429 = fmul float %84, %conv108
  %85 = load float, float* %arrayidx4.10, align 4, !tbaa !8
  %mul433 = fmul float %mul429, %85
  %86 = load float, float* %arrayidx4.1, align 4, !tbaa !8
  %mul437 = fmul float %mul433, %86
  store float %mul437, float* %arrayidx428, align 4, !tbaa !8
  %add442 = add i64 %call, 960
  %arrayidx443 = getelementptr inbounds float, float* %c, i64 %add442
  %87 = load float, float* %arrayidx443, align 4, !tbaa !8
  %mul444 = fmul float %add5.21, %87
  %88 = load float, float* %arrayidx4.13, align 4, !tbaa !8
  %mul448 = fmul float %mul444, %88
  %89 = load float, float* %arrayidx4.8, align 4, !tbaa !8
  %mul452 = fmul float %mul448, %89
  store float %mul452, float* %arrayidx443, align 4, !tbaa !8
  %arrayidx458 = getelementptr inbounds float, float* %d, i64 %add442
  %90 = load float, float* %arrayidx458, align 4, !tbaa !8
  %mul459 = fmul float %add5.21, %90
  %91 = load float, float* %arrayidx4.19, align 4, !tbaa !8
  %mul463 = fmul float %mul459, %91
  store float %mul463, float* %arrayidx458, align 4, !tbaa !8
  %arrayidx469 = getelementptr inbounds float, float* %e, i64 %add.12
  %92 = load float, float* %arrayidx469, align 4, !tbaa !8
  %add471 = add i64 %call, 1000
  %arrayidx472 = getelementptr inbounds float, float* %c, i64 %add471
  %93 = load float, float* %arrayidx472, align 4, !tbaa !8
  %div = fdiv float 1.000000e+00, %93, !fpmath !12
  ...
  %call481 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul474, float 0x3810000000000000) #3
  %call482 = tail call float @"?log10@@$$J0YAMM@Z"(float %call481) #3
  %mul483 = fmul float %mul, 0xBF43323D80000000
  %call484 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul483) #3
  %mul487 = fmul float %mul, 0xBF347AE140000000
  %call488 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul487) #3
  ...
  %div490 = fdiv float 1.000000e+00, %mul, !fpmath !12
  %mul491 = fmul float %div490, -4.131000e+03
  %call492 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul491) #3
  %add493 = fadd float %call492, %94
  %call494 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add493, float 0x3810000000000000) #3
  %call495 = tail call float @"?log10@@$$J0YAMM@Z"(float %call494) #3
  ...
  %call518 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv517) #3
  %mul519 = fmul float %call518, %conv480
  %mul523 = fmul float %93, %mul519
  store float %mul523, float* %arrayidx472, align 4, !tbaa !8
  %arrayidx529 = getelementptr inbounds float, float* %d, i64 %add471
  %98 = load float, float* %arrayidx529, align 4, !tbaa !8
  %mul530 = fmul float %mul519, %98
  store float %mul530, float* %arrayidx529, align 4, !tbaa !8
  %arrayidx536 = getelementptr inbounds float, float* %e, i64 %add.13
  %99 = load float, float* %arrayidx536, align 4, !tbaa !8
  %add538 = add i64 %call, 1048
  %arrayidx539 = getelementptr inbounds float, float* %c, i64 %add538
  %100 = load float, float* %arrayidx539, align 4, !tbaa !8
  %div540 = fdiv float 1.000000e+00, %100, !fpmath !12
  ...
  %call549 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul542, float 0x3810000000000000) #3
  %call550 = tail call float @"?log10@@$$J0YAMM@Z"(float %call549) #3
  %mul552 = fmul float %mul, 0xBF73BD60E0000000
  %call553 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul552) #3
  %mul556 = fmul float %mul, 0xBF389C1E60000000
  %call557 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul556) #3
  ...
  %call561 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul560) #3
  %add562 = fadd float %call561, %101
  %call563 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add562, float 0x3810000000000000) #3
  %call564 = tail call float @"?log10@@$$J0YAMM@Z"(float %call563) #3
  ...
  %call587 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv586) #3
  %mul588 = fmul float %call587, %conv548
  %mul592 = fmul float %100, %mul588
  store float %mul592, float* %arrayidx539, align 4, !tbaa !8
  %arrayidx598 = getelementptr inbounds float, float* %d, i64 %add538
  %105 = load float, float* %arrayidx598, align 4, !tbaa !8
  %mul599 = fmul float %mul588, %105
  store float %mul599, float* %arrayidx598, align 4, !tbaa !8
  %arrayidx605 = getelementptr inbounds float, float* %e, i64 %add.14
  %106 = load float, float* %arrayidx605, align 4, !tbaa !8
  %add607 = add i64 %call, 1152
  %arrayidx608 = getelementptr inbounds float, float* %c, i64 %add607
  %107 = load float, float* %arrayidx608, align 4, !tbaa !8
  %div609 = fdiv float 1.000000e+00, %107, !fpmath !12
  ...
  %call618 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul611, float 0x3810000000000000) #3
  %call619 = tail call float @"?log10@@$$J0YAMM@Z"(float %call618) #3
  %mul621 = fmul float %mul, 0xBF48715A80000000
  %call622 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul621) #3
  %mul625 = fmul float %mul, 0xBEF179ECA0000000
  %call626 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul625) #3
  ...
  %call630 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul629) #3
  %add631 = fadd float %call630, %108
  %call632 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add631, float 0x3810000000000000) #3
  %call633 = tail call float @"?log10@@$$J0YAMM@Z"(float %call632) #3
  ...
  %call656 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv655) #3
  %mul657 = fmul float %call656, %conv617
  %mul661 = fmul float %107, %mul657
  store float %mul661, float* %arrayidx608, align 4, !tbaa !8
  %arrayidx667 = getelementptr inbounds float, float* %d, i64 %add607
  %112 = load float, float* %arrayidx667, align 4, !tbaa !8
  ...
  %113 = load float, float* %arrayidx674, align 4, !tbaa !8
  %add676 = add i64 %call, 1176
  %arrayidx677 = getelementptr inbounds float, float* %c, i64 %add676
  %114 = load float, float* %arrayidx677, align 4, !tbaa !8
  %div678 = fdiv float 1.000000e+00, %114, !fpmath !12
  ...
  %call687 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul680, float 0x3810000000000000) #3
  %call688 = tail call float @"?log10@@$$J0YAMM@Z"(float %call687) #3
  %mul690 = fmul float %mul, 0xBF1D745260000000
  %call691 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul690) #3
  %mul694 = fmul float %mul, 0xBF2E21A9A0000000
  %call695 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul694) #3
  ...
  %call699 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul698) #3
  %add700 = fadd float %call699, %115
  %call701 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add700, float 0x3810000000000000) #3
  %call702 = tail call float @"?log10@@$$J0YAMM@Z"(float %call701) #3
  ...
  %call725 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv724) #3
  %mul726 = fmul float %call725, %conv686
  %mul730 = fmul float %114, %mul726
  store float %mul730, float* %arrayidx677, align 4, !tbaa !8
  %arrayidx736 = getelementptr inbounds float, float* %d, i64 %add676
  %119 = load float, float* %arrayidx736, align 4, !tbaa !8
  %mul737 = fmul float %mul726, %119
  store float %mul737, float* %arrayidx736, align 4, !tbaa !8
  %arrayidx743 = getelementptr inbounds float, float* %e, i64 %add.16
  %120 = load float, float* %arrayidx743, align 4, !tbaa !8
  %add745 = add i64 %call, 1232
  %arrayidx746 = getelementptr inbounds float, float* %c, i64 %add745
  %121 = load float, float* %arrayidx746, align 4, !tbaa !8
  %div747 = fdiv float 1.000000e+00, %121, !fpmath !12
  ...
  %call756 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul749, float 0x3810000000000000) #3
  %call757 = tail call float @"?log10@@$$J0YAMM@Z"(float %call756) #3
  %mul759 = fmul float %mul, 0xBF76C16C20000000
  %call760 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul759) #3
  %mul763 = fmul float %mul, 0xBF4FA8EF60000000
  %call764 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul763) #3
  ...
  %call768 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul767) #3
  %add769 = fadd float %call768, %122
  %call770 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add769, float 0x3810000000000000) #3
  %call771 = tail call float @"?log10@@$$J0YAMM@Z"(float %call770) #3
  ...
  %call794 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv793) #3
  %mul795 = fmul float %call794, %conv755
  %mul799 = fmul float %121, %mul795
  store float %mul799, float* %arrayidx746, align 4, !tbaa !8
  %arrayidx805 = getelementptr inbounds float, float* %d, i64 %add745
  %126 = load float, float* %arrayidx805, align 4, !tbaa !8
  %mul806 = fmul float %mul795, %126
  store float %mul806, float* %arrayidx805, align 4, !tbaa !8
  %arrayidx812 = getelementptr inbounds float, float* %e, i64 %add.17
  %127 = load float, float* %arrayidx812, align 4, !tbaa !8
  %add814 = add i64 %call, 1240
  %arrayidx815 = getelementptr inbounds float, float* %c, i64 %add814
  %128 = load float, float* %arrayidx815, align 4, !tbaa !8
  %div816 = fdiv float 1.000000e+00, %128, !fpmath !12
  ...
  %call825 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul818, float 0x3810000000000000) #3
  %call826 = tail call float @"?log10@@$$J0YAMM@Z"(float %call825) #3
  %mul828 = fmul float %mul, 0xBF73813820000000
  %call829 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul828) #3
  %mul832 = fmul float %mul, 0xBF50A68100000000
  %call833 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul832) #3
  ...
  %call837 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul836) #3
  %add838 = fadd float %call837, %129
  %call839 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add838, float 0x3810000000000000) #3
  %call840 = tail call float @"?log10@@$$J0YAMM@Z"(float %call839) #3
  ...
  %call863 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv862) #3
  %mul864 = fmul float %call863, %conv824
  %mul868 = fmul float %128, %mul864
  store float %mul868, float* %arrayidx815, align 4, !tbaa !8
  %arrayidx874 = getelementptr inbounds float, float* %d, i64 %add814
  %133 = load float, float* %arrayidx874, align 4, !tbaa !8
  %mul875 = fmul float %mul864, %133
  store float %mul875, float* %arrayidx874, align 4, !tbaa !8
  %arrayidx881 = getelementptr inbounds float, float* %e, i64 %add.18
  %134 = load float, float* %arrayidx881, align 4, !tbaa !8
  %add883 = add i64 %call, 1352
  %arrayidx884 = getelementptr inbounds float, float* %c, i64 %add883
  %135 = load float, float* %arrayidx884, align 4, !tbaa !8
  %div885 = fdiv float 1.000000e+00, %135, !fpmath !12
  ...
  %call894 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul887, float 0x3810000000000000) #3
  %call895 = tail call float @"?log10@@$$J0YAMM@Z"(float %call894) #3
  %mul897 = fmul float %mul, 0xBF80624DE0000000
  %call898 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul897) #3
  %mul901 = fmul float %mul, 0xBF3D88B5E0000000
  %call902 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul901) #3
  ...
  %call906 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul905) #3
  %add907 = fadd float %call906, %136
  %call908 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %add907, float 0x3810000000000000) #3
  %call909 = tail call float @"?log10@@$$J0YAMM@Z"(float %call908) #3
  ...
  %call932 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv931) #3
  %mul933 = fmul float %call932, %conv893
  %mul937 = fmul float %135, %mul933
  store float %mul937, float* %arrayidx884, align 4, !tbaa !8
  %arrayidx943 = getelementptr inbounds float, float* %d, i64 %add883
  %140 = load float, float* %arrayidx943, align 4, !tbaa !8
  %mul944 = fmul float %mul933, %140
  store float %mul944, float* %arrayidx943, align 4, !tbaa !8
  %arrayidx950 = getelementptr inbounds float, float* %e, i64 %add.19
  %141 = load float, float* %arrayidx950, align 4, !tbaa !8
  %add952 = add i64 %call, 1472
  %arrayidx953 = getelementptr inbounds float, float* %c, i64 %add952
  %142 = load float, float* %arrayidx953, align 4, !tbaa !8
  %div954 = fdiv float 1.000000e+00, %142, !fpmath !12
  ...
  %call963 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul956, float 0x3810000000000000) #3
  %call964 = tail call float @"?log10@@$$J0YAMM@Z"(float %call963) #3
  %mul966 = fmul float %mul, 0xBF4DE1A6E0000000
  %call967 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul966) #3
  ...
  %call977 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul976) #3
  %conv978 = fpext float %call977 to double
  %add979 = fadd double %143, %conv978
  %conv980 = fptrunc double %add979 to float
  %call981 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %conv980, float 0x3810000000000000) #3
  %call982 = tail call float @"?log10@@$$J0YAMM@Z"(float %call981) #3
  ...
  %call1005 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv1004) #3
  %mul1006 = fmul float %call1005, %conv962
  %mul1010 = fmul float %142, %mul1006
  store float %mul1010, float* %arrayidx953, align 4, !tbaa !8
  %arrayidx1016 = getelementptr inbounds float, float* %d, i64 %add952
  %147 = load float, float* %arrayidx1016, align 4, !tbaa !8
  %mul1017 = fmul float %147, %mul1006
  store float %mul1017, float* %arrayidx1016, align 4, !tbaa !8
  %arrayidx1023 = getelementptr inbounds float, float* %e, i64 %add.20
  %148 = load float, float* %arrayidx1023, align 4, !tbaa !8
  %add1025 = add i64 %call, 1512
  %arrayidx1026 = getelementptr inbounds float, float* %c, i64 %add1025
  %149 = load float, float* %arrayidx1026, align 4, !tbaa !8
  %div1027 = fdiv float 1.000000e+00, %149, !fpmath !12
  ...
  %call1036 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %mul1029, float 0x3810000000000000) #3
  %call1037 = tail call float @"?log10@@$$J0YAMM@Z"(float %call1036) #3
  %mul1039 = fmul float %mul, 0xBF50624DE0000000
  %call1040 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul1039) #3
  %conv1041 = fpext float %call1040 to double
  %mul1044 = fmul float %mul, 0xBF49038480000000
  %call1045 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul1044) #3
  ...
  %call1050 = tail call float @"?exp@@$$J0YAMM@Z"(float %mul1049) #3
  %conv1051 = fpext float %call1050 to double
  %add1052 = fadd double %150, %conv1051
  %conv1053 = fptrunc double %add1052 to float
  %call1054 = tail call float @"?fmax@@$$J0YAMMM@Z"(float %conv1053, float 0x3810000000000000) #3
  %call1055 = tail call float @"?log10@@$$J0YAMM@Z"(float %call1054) #3
  ...
  %call1078 = tail call float @"?exp10@@$$J0YAMM@Z"(float %conv1077) #3
  %mul1079 = fmul float %call1078, %conv1035
  %mul1083 = fmul float %149, %mul1079
  store float %mul1083, float* %arrayidx1026, align 4, !tbaa !8
  %arrayidx1089 = getelementptr inbounds float, float* %d, i64 %add1025
  %154 = load float, float* %arrayidx1089, align 4, !tbaa !8
  %mul1090 = fmul float %mul1079, %154
  store float %mul1090, float* %arrayidx1089, align 4, !tbaa !8
  ret void
}
...
; Function Attrs: convergent nounwind readnone
declare dso_local float @"?log10@@$$J0YAMM@Z"(float) local_unnamed_addr #1
...
; Function Attrs: convergent nounwind readnone
declare dso_local float @"?exp10@@$$J0YAMM@Z"(float) local_unnamed_addr #1
