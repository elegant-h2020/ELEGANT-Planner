; ModuleID = './kernels/kernels/npb-3.3-CG-makea_1.cl'
source_filename = "./kernels/kernels/npb-3.3-CG-makea_1.cl"
...
define dso_local spir_kernel void @A(i32* nocapture %a, i32* nocapture readonly %b, i32* nocapture readonly %c, i32* nocapture %d, i32* nocapture readonly %e, i32* nocapture readonly %f, i32 %g) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
for.cond9.preheader:                              ; preds = %for.cond9.preheader.preheader, %for.inc33
  ...
  %3 = load i32, i32* %arrayidx11, align 4, !tbaa !8
...
for.body14:                                       ; preds = %for.cond9.preheader, %for.inc
  ...
  %5 = load i32, i32* %arrayidx18, align 4, !tbaa !8
  %cmp19.not = icmp sge i32 %5, %1
  %cmp21 = icmp slt i32 %5, %2
  %or.cond = and i1 %cmp19.not, %cmp21
...
if.then23:                                        ; preds = %for.body14
  ...
  %6 = load i32, i32* %arrayidx26, align 4, !tbaa !8
  %add29 = add nsw i32 %6, %4
  store i32 %add29, i32* %arrayidx26, align 4, !tbaa !8
  %.pre = load i32, i32* %arrayidx11, align 4, !tbaa !8
  br label %for.inc
...
for.inc33:                                        ; preds = %for.inc, %for.cond9.preheader
  ...
  br i1 %exitcond129.not, label %for.end35, label %for.cond9.preheader
...
for.body45.preheader:                             ; preds = %if.end40
  ...
  %.pre130 = load i32, i32* %arrayidx49.phi.trans.insert, align 4, !tbaa !8
  %10 = sub nsw i64 %wide.trip.count, %9
  %11 = xor i64 %9, -1
  %12 = add nsw i64 %11, %wide.trip.count
  %xtraiter = and i64 %10, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body45.prol.loopexit, label %for.body45.prol
...
for.body45.prol:                                  ; preds = %for.body45.preheader, %for.body45.prol
  ...
  %14 = load i32, i32* %arrayidx47.prol, align 4, !tbaa !8
  %add50.prol = add nsw i32 %13, %14
  store i32 %add50.prol, i32* %arrayidx47.prol, align 4, !tbaa !8
  %prol.iter.sub = add i64 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body45.prol.loopexit, label %for.body45.prol, !llvm.loop !12
...
for.body45:                                       ; preds = %for.body45.prol.loopexit, %for.body45
  ...
  %17 = load i32, i32* %arrayidx47, align 4, !tbaa !8
  %add50 = add nsw i32 %16, %17
  store i32 %add50, i32* %arrayidx47, align 4, !tbaa !8
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx47.1 = getelementptr inbounds i32, i32* %a, i64 %indvars.iv.next.1
  %18 = load i32, i32* %arrayidx47.1, align 4, !tbaa !8
  %add50.1 = add nsw i32 %add50, %18
  store i32 %add50.1, i32* %arrayidx47.1, align 4, !tbaa !8
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx47.2 = getelementptr inbounds i32, i32* %a, i64 %indvars.iv.next.2
  %19 = load i32, i32* %arrayidx47.2, align 4, !tbaa !8
  %add50.2 = add nsw i32 %add50.1, %19
  store i32 %add50.2, i32* %arrayidx47.2, align 4, !tbaa !8
  %indvars.iv.next.3 = add nsw i64 %indvars.iv, 4
  %arrayidx47.3 = getelementptr inbounds i32, i32* %a, i64 %indvars.iv.next.3
  %20 = load i32, i32* %arrayidx47.3, align 4, !tbaa !8
  %add50.3 = add nsw i32 %add50.2, %20
  store i32 %add50.3, i32* %arrayidx47.3, align 4, !tbaa !8
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %for.end55, label %for.body45
...
if.then58:                                        ; preds = %for.end55
  ...
  %21 = load i32, i32* %arrayidx61, align 4, !tbaa !8
  %arrayidx63 = getelementptr inbounds i32, i32* %d, i64 %idxprom
  store i32 %21, i32* %arrayidx63, align 4, !tbaa !8
  br label %cleanup
