; ModuleID = './kernels/kernels/rodinia-3.1-cfd-memset_kernel.cl'
source_filename = "./kernels/kernels/rodinia-3.1-cfd-memset_kernel.cl"
...
if.end:                                           ; preds = %entry
  %conv2 = trunc i16 %b to i8
  %sext = shl i64 %call, 32
  %idxprom = ashr exact i64 %sext, 32
  %arrayidx = getelementptr inbounds i8, i8* %a, i64 %idxprom
  store i8 %conv2, i8* %arrayidx, align 1, !tbaa !8
  br label %cleanup
