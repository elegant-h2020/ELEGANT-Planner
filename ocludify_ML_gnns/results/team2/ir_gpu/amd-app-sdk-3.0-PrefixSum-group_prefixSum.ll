; ModuleID = './kernels/kernels/amd-app-sdk-3.0-PrefixSum-group_prefixSum.cl'
source_filename = "./kernels/kernels/amd-app-sdk-3.0-PrefixSum-group_prefixSum.cl"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc19.16.27025"

; Function Attrs: convergent norecurse nounwind uwtable
define dso_local spir_kernel void @A(float* nocapture %a, float* nocapture readonly %b, float* nocapture %c, i32 %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  %call = tail call i64 @"?get_local_id@@$$J0YAKI@Z"(i32 0) #3
  %conv = trunc i64 %call to i32
  %call1 = tail call i64 @"?get_local_size@@$$J0YAKI@Z"(i32 0) #3
...
if.end23:                                         ; preds = %if.then15, %if.end
  %j.0166 = lshr i32 %d, 1
  %cmp24.not167 = icmp eq i32 %j.0166, 0
  br i1 %cmp24.not167, label %for.cond.cleanup, label %for.body.lr.ph
...
if.then62:                                        ; preds = %for.body57
  ...
  %8 = load float, float* %arrayidx71, align 4, !tbaa !8
  %idxprom72 = sext i32 %add69 to i64
  %arrayidx73 = getelementptr inbounds float, float* %c, i64 %idxprom72
  %9 = load float, float* %arrayidx73, align 4, !tbaa !8
  %add74 = fadd float %8, %9
  store float %add74, float* %arrayidx73, align 4, !tbaa !8
  br label %for.inc76
