; ModuleID = './kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced3.cl'
source_filename = "./kernels/kernels/nvidia-4.2-MatVecMul-MatVecMulCoalesced3.cl"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc19.16.27025"

; Function Attrs: convergent norecurse nounwind uwtable
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readonly %b, i32 %c, i32 %d, float* nocapture %e, float* %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
for.body8.lr.ph:                                  ; preds = %for.body
  %call12 = tail call i64 @"?get_local_size@@$$J0YAKI@Z"(i32 0) #4
  br label %for.body8
...
for.cond.cleanup7:                                ; preds = %for.body8, %for.body
  ...
  %call20 = tail call i64 @"?get_local_size@@$$J0YAKI@Z"(i32 0) #4
...
if.then:                                          ; preds = %for.cond.cleanup7
  %4 = load volatile float, float* %arrayidx28, align 4, !tbaa !8
  %5 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add30 = fadd float %4, %5
  store volatile float %add30, float* %add.ptr27, align 4, !tbaa !8
  %6 = load volatile float, float* %arrayidx31, align 4, !tbaa !8
  %7 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add33 = fadd float %6, %7
  store volatile float %add33, float* %add.ptr27, align 4, !tbaa !8
  %8 = load volatile float, float* %arrayidx34, align 4, !tbaa !8
  %9 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add36 = fadd float %8, %9
  store volatile float %add36, float* %add.ptr27, align 4, !tbaa !8
  %10 = load volatile float, float* %arrayidx37, align 4, !tbaa !8
  %11 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add39 = fadd float %10, %11
  store volatile float %add39, float* %add.ptr27, align 4, !tbaa !8
  %12 = load volatile float, float* %arrayidx40, align 4, !tbaa !8
  %13 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add42 = fadd float %12, %13
  store volatile float %add42, float* %add.ptr27, align 4, !tbaa !8
  %14 = load volatile float, float* %arrayidx43, align 4, !tbaa !8
  %15 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  %add45 = fadd float %14, %15
  store volatile float %add45, float* %add.ptr27, align 4, !tbaa !8
  %16 = load volatile float, float* %add.ptr27, align 4, !tbaa !8
  br label %if.end
...
if.then49:                                        ; preds = %if.end
  store float %l.0, float* %arrayidx52, align 4, !tbaa !8
  br label %if.end53
...
if.end72.thread:                                  ; preds = %if.then62
  %17 = load volatile float, float* %arrayidx69, align 4, !tbaa !8
  %18 = load volatile float, float* %arrayidx16, align 4, !tbaa !8
  %add71 = fadd float %17, %18
  store volatile float %add71, float* %arrayidx16, align 4, !tbaa !8
...
if.end79.thread:                                  ; preds = %if.end72, %if.end72.thread
  %19 = load volatile float, float* %arrayidx76, align 4, !tbaa !8
  %20 = load volatile float, float* %arrayidx16, align 4, !tbaa !8
  %add78 = fadd float %19, %20
  store volatile float %add78, float* %arrayidx16, align 4, !tbaa !8
  br label %if.then82
...
if.then82:                                        ; preds = %if.end79.thread, %if.end79
  %21 = load volatile float, float* %arrayidx83, align 4, !tbaa !8
  %22 = load volatile float, float* %arrayidx16, align 4, !tbaa !8
  %add85 = fadd float %21, %22
  store volatile float %add85, float* %arrayidx16, align 4, !tbaa !8
  br label %if.end87
...
if.then91:                                        ; preds = %if.end87
  %23 = load i32, i32* %0, align 4, !tbaa !8
...
if.end95:                                         ; preds = %if.end87.if.end95_crit_edge, %if.then91
  ...
  tail call void @"?barrier@@$$J0YAXI@Z"(i32 1) #5
  %call97 = tail call i64 @"?get_num_groups@@$$J0YAKI@Z"(i32 0) #4
