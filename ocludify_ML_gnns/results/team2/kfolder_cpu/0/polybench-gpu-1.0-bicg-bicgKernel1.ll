; ModuleID = './kernels/kernels/polybench-gpu-1.0-bicg-bicgKernel1.cl'
source_filename = "./kernels/kernels/polybench-gpu-1.0-bicg-bicgKernel1.cl"
...
if.then:                                          ; preds = %entry
  ...
  %cmp221 = icmp sgt i32 %e, 0
  br i1 %cmp221, label %for.body.lr.ph, label %if.end
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  %2 = phi float [ 0.000000e+00, %for.body.lr.ph.new ], [ %10, %for.body ]
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph.new ], [ %indvars.iv.next.1, %for.body ]
  %niter = phi i64 [ %unroll_iter, %for.body.lr.ph.new ], [ %niter.nsub.1, %for.body ]
  %3 = add nsw i64 %indvars.iv, %0
  %arrayidx5 = getelementptr inbounds float, float* %a, i64 %3
...
if.end.loopexit.unr-lcssa:                        ; preds = %for.body, %for.body.lr.ph
  %.unr = phi float [ 0.000000e+00, %for.body.lr.ph ], [ %10, %for.body ]
...
for.body.epil:                                    ; preds = %if.end.loopexit.unr-lcssa
  ...
  %arrayidx5.epil = getelementptr inbounds float, float* %a, i64 %11
  %12 = load float, float* %arrayidx5.epil, align 4, !tbaa !8
  %arrayidx7.epil = getelementptr inbounds float, float* %b, i64 %indvars.iv.unr
  %13 = load float, float* %arrayidx7.epil, align 4, !tbaa !8
