; ModuleID = './kernels/kernels/polybench-gpu-1.0-atax-atax_kernel2.cl'
source_filename = "./kernels/kernels/polybench-gpu-1.0-atax-atax_kernel2.cl"
...
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture %b, float* nocapture readonly %c, i32 %d, i32 %e) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %0 = sext i32 %e to i64
  %sext21 = shl i64 %call, 32
  %1 = ashr exact i64 %sext21, 32
