; ModuleID = './kernels/kernels/npb-3.3-CG-main_1.cl'
source_filename = "./kernels/kernels/npb-3.3-CG-main_1.cl"
...
define dso_local spir_kernel void @A(double* nocapture %a) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  store double 1.000000e+00, double* %arrayidx, align 8, !tbaa !8
  br label %cleanup
