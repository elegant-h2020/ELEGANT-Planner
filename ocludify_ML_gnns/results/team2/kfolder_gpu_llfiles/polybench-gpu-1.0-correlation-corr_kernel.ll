; ModuleID = './kernels/kernels/polybench-gpu-1.0-correlation-corr_kernel.cl'
source_filename = "./kernels/kernels/polybench-gpu-1.0-correlation-corr_kernel.cl"
...
if.then:                                          ; preds = %entry
  ...
  %cmp8.not76 = icmp sgt i32 %add6, %c
  br i1 %cmp8.not76, label %if.end, label %for.cond10.preheader.lr.ph
...
for.cond10.preheader:                             ; preds = %for.cond10.preheader.lr.ph, %for.end
  %indvars.iv82 = phi i64 [ %4, %for.cond10.preheader.lr.ph ], [ %indvars.iv.next83, %for.end ]
  %.pre89 = add nsw i64 %indvars.iv82, %5
  br i1 %cmp12.not74, label %for.end, label %for.body14.lr.ph

for.body14.lr.ph:                                 ; preds = %for.cond10.preheader
  %arrayidx30 = getelementptr inbounds float, float* %a, i64 %.pre89
  %.pre = load float, float* %arrayidx30, align 4, !tbaa !8
...
for.body14:                                       ; preds = %for.body14.lr.ph, %for.body14
  ...
  store float %14, float* %arrayidx30, align 4, !tbaa !8
  ...
  store float %20, float* %arrayidx30, align 4, !tbaa !8
...
for.end.loopexit.unr-lcssa:                       ; preds = %for.body14, %for.body14.lr.ph
  ...
  br i1 %lcmp.mod.not, label %for.end, label %for.body14.epil
...
for.body14.epil:                                  ; preds = %for.end.loopexit.unr-lcssa
  ...
  store float %26, float* %arrayidx30, align 4, !tbaa !8
  br label %for.end

for.end:                                          ; preds = %for.body14.epil, %for.end.loopexit.unr-lcssa, %for.cond10.preheader
  %arrayidx35 = getelementptr inbounds float, float* %a, i64 %.pre89
  ...
  %exitcond88.not = icmp eq i32 %add4, %lftr.wideiv
  br i1 %exitcond88.not, label %if.end, label %for.cond10.preheader
