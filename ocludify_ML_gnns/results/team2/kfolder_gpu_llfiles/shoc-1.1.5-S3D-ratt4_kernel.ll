; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-ratt4_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-ratt4_kernel.cl"
...
entry:
  ...
  %10 = load float, float* %arrayidx50, align 4, !tbaa !8
  ...
  %14 = load float, float* %arrayidx68, align 4, !tbaa !8
  ...
  %18 = load float, float* %arrayidx89, align 4, !tbaa !8
  ...
  %21 = load float, float* %arrayidx106, align 4, !tbaa !8
  %22 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul110 = fmul float %21, %22
  %23 = load float, float* %arrayidx12, align 4, !tbaa !8
  %24 = load float, float* %arrayidx68, align 4, !tbaa !8
  ...
  %27 = load float, float* %arrayidx133, align 4, !tbaa !8
  ...
  %28 = load float, float* %arrayidx138, align 4, !tbaa !8
  %div139 = fdiv float 1.000000e+00, %28, !fpmath !12
  ...
  %call144 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul140, float 0x4415AF1D80000000) #2
  %mul145 = fmul float %29, %call144
  %arrayidx148 = getelementptr inbounds float, float* %c, i64 %add142
  store float %mul145, float* %arrayidx148, align 4, !tbaa !8
  %30 = load float, float* %arrayidx92, align 4, !tbaa !8
  ...
  %33 = load float, float* %arrayidx161, align 4, !tbaa !8
  %mul162 = fmul float %32, %33
  %div163 = fdiv float 1.000000e+00, %mul162, !fpmath !12
  %mul164 = fmul float %mul155, %div163
  %add166 = add i64 %call, 448
  %arrayidx167 = getelementptr inbounds float, float* %b, i64 %add166
  %34 = load float, float* %arrayidx167, align 4, !tbaa !8
  %call168 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul164, float 0x4415AF1D80000000) #2
  %mul169 = fmul float %34, %call168
  %arrayidx172 = getelementptr inbounds float, float* %c, i64 %add166
  store float %mul169, float* %arrayidx172, align 4, !tbaa !8
  ...
  %42 = load float, float* %arrayidx36, align 4, !tbaa !8
  %43 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul219 = fmul float %42, %43
  %44 = load float, float* %arrayidx182, align 4, !tbaa !8
  %45 = load float, float* %arrayidx92, align 4, !tbaa !8
  ...
  %46 = load float, float* %arrayidx231, align 4, !tbaa !8
  ...
  %47 = load float, float* %arrayidx239, align 4, !tbaa !8
  %48 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul243 = fmul float %47, %48
  %49 = load float, float* %arrayidx182, align 4, !tbaa !8
  %50 = load float, float* %arrayidx133, align 4, !tbaa !8
  ...
  %51 = load float, float* %arrayidx255, align 4, !tbaa !8
  ...
  %52 = load float, float* %arrayidx239, align 4, !tbaa !8
  %53 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul267 = fmul float %52, %53
  %54 = load float, float* %arrayidx36, align 4, !tbaa !8
  %55 = load float, float* %arrayidx15, align 4, !tbaa !8
  ...
  %56 = load float, float* %arrayidx279, align 4, !tbaa !8
  ...
  %57 = load float, float* %arrayidx12, align 4, !tbaa !8
  %58 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul291 = fmul float %57, %58
  %59 = load float, float* %arrayidx36, align 4, !tbaa !8
  %60 = load float, float* %arrayidx68, align 4, !tbaa !8
  ...
  %61 = load float, float* %arrayidx303, align 4, !tbaa !8
  ...
  %62 = load float, float* %arrayidx182, align 4, !tbaa !8
  %63 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul315 = fmul float %62, %63
  %64 = load float, float* %arrayidx36, align 4, !tbaa !8
  %add320 = add i64 %call, 88
  %arrayidx321 = getelementptr inbounds float, float* %d, i64 %add320
  %65 = load float, float* %arrayidx321, align 4, !tbaa !8
  ...
  %66 = load float, float* %arrayidx327, align 4, !tbaa !8
  ...
  %68 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul339 = fmul float %67, %68
  %69 = load float, float* %arrayidx36, align 4, !tbaa !8
  %70 = load float, float* %arrayidx12, align 4, !tbaa !8
  %mul346 = fmul float %69, %70
  %71 = load float, float* %arrayidx133, align 4, !tbaa !8
  ...
  %72 = load float, float* %arrayidx356, align 4, !tbaa !8
  ...
  %73 = load float, float* %arrayidx5, align 4, !tbaa !8
  %74 = load float, float* %arrayidx199, align 4, !tbaa !8
  %mul368 = fmul float %73, %74
  %75 = load float, float* %arrayidx89, align 4, !tbaa !8
  %76 = load float, float* %arrayidx133, align 4, !tbaa !8
  ...
  %77 = load float, float* %arrayidx380, align 4, !tbaa !8
  ...
  %78 = load float, float* %arrayidx199, align 4, !tbaa !8
  %79 = load float, float* %arrayidx8, align 4, !tbaa !8
  %div392 = fdiv float 1.000000e+00, %79, !fpmath !12
  %mul393 = fmul float %78, %div392
  %add395 = add i64 %call, 528
  %arrayidx396 = getelementptr inbounds float, float* %b, i64 %add395
  %80 = load float, float* %arrayidx396, align 4, !tbaa !8
  %call397 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul393, float 0x4415AF1D80000000) #2
  %mul398 = fmul float %80, %call397
  %arrayidx401 = getelementptr inbounds float, float* %c, i64 %add395
  store float %mul398, float* %arrayidx401, align 4, !tbaa !8
  %81 = load float, float* %arrayidx199, align 4, !tbaa !8
  %82 = load float, float* %arrayidx8, align 4, !tbaa !8
  %div408 = fdiv float 1.000000e+00, %82, !fpmath !12
  %mul409 = fmul float %81, %div408
  %add411 = add i64 %call, 536
  %arrayidx412 = getelementptr inbounds float, float* %b, i64 %add411
  %83 = load float, float* %arrayidx412, align 4, !tbaa !8
  %call413 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul409, float 0x4415AF1D80000000) #2
  %mul414 = fmul float %83, %call413
  %arrayidx417 = getelementptr inbounds float, float* %c, i64 %add411
  store float %mul414, float* %arrayidx417, align 4, !tbaa !8
  %84 = load float, float* %arrayidx199, align 4, !tbaa !8
  %85 = load float, float* %arrayidx8, align 4, !tbaa !8
  %div424 = fdiv float 1.000000e+00, %85, !fpmath !12
  %mul425 = fmul float %84, %div424
  %add427 = add i64 %call, 544
  %arrayidx428 = getelementptr inbounds float, float* %b, i64 %add427
  %86 = load float, float* %arrayidx428, align 4, !tbaa !8
  ...
  %87 = load float, float* %arrayidx199, align 4, !tbaa !8
  %88 = load float, float* %arrayidx43, align 4, !tbaa !8
  %mul440 = fmul float %87, %88
  %89 = load float, float* %arrayidx133, align 4, !tbaa !8
  %90 = load float, float* %arrayidx68, align 4, !tbaa !8
  %mul447 = fmul float %89, %90
  %div448 = fdiv float 1.000000e+00, %mul447, !fpmath !12
  %mul449 = fmul float %mul440, %div448
  %add451 = add i64 %call, 552
  %arrayidx452 = getelementptr inbounds float, float* %b, i64 %add451
  %91 = load float, float* %arrayidx452, align 4, !tbaa !8
  %call453 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul449, float 0x4415AF1D80000000) #2
  %mul454 = fmul float %91, %call453
  %arrayidx457 = getelementptr inbounds float, float* %c, i64 %add451
  store float %mul454, float* %arrayidx457, align 4, !tbaa !8
  %92 = load float, float* %arrayidx36, align 4, !tbaa !8
  %93 = load float, float* %arrayidx68, align 4, !tbaa !8
  ...
  %94 = load float, float* %arrayidx468, align 4, !tbaa !8
  %div469 = fdiv float 1.000000e+00, %94, !fpmath !12
  %mul470 = fmul float %mul465, %div469
  %add472 = add i64 %call, 560
  %arrayidx473 = getelementptr inbounds float, float* %b, i64 %add472
  %95 = load float, float* %arrayidx473, align 4, !tbaa !8
  %call474 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul470, float 0x4415AF1D80000000) #2
  %mul475 = fmul float %95, %call474
  %arrayidx478 = getelementptr inbounds float, float* %c, i64 %add472
  store float %mul475, float* %arrayidx478, align 4, !tbaa !8
  %96 = load float, float* %arrayidx36, align 4, !tbaa !8
  %97 = load float, float* %arrayidx68, align 4, !tbaa !8
  %mul485 = fmul float %96, %97
  %98 = load float, float* %arrayidx182, align 4, !tbaa !8
  %99 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul492 = fmul float %98, %99
  %div493 = fdiv float 1.000000e+00, %mul492, !fpmath !12
  %mul494 = fmul float %mul485, %div493
  %add496 = add i64 %call, 568
  %arrayidx497 = getelementptr inbounds float, float* %b, i64 %add496
  %100 = load float, float* %arrayidx497, align 4, !tbaa !8
  %call498 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul494, float 0x4415AF1D80000000) #2
  ...
  %101 = load float, float* %arrayidx239, align 4, !tbaa !8
  %102 = load float, float* %arrayidx68, align 4, !tbaa !8
  %mul509 = fmul float %101, %102
  %103 = load float, float* %arrayidx12, align 4, !tbaa !8
  %104 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul516 = fmul float %103, %104
  %div517 = fdiv float 1.000000e+00, %mul516, !fpmath !12
  %mul518 = fmul float %mul509, %div517
  %add520 = add i64 %call, 576
  %arrayidx521 = getelementptr inbounds float, float* %b, i64 %add520
  %105 = load float, float* %arrayidx521, align 4, !tbaa !8
  %call522 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul518, float 0x4415AF1D80000000) #2
  %mul523 = fmul float %105, %call522
  %arrayidx526 = getelementptr inbounds float, float* %c, i64 %add520
  store float %mul523, float* %arrayidx526, align 4, !tbaa !8
  %106 = load float, float* %arrayidx12, align 4, !tbaa !8
  %107 = load float, float* %arrayidx68, align 4, !tbaa !8
  %mul533 = fmul float %106, %107
  %108 = load float, float* %arrayidx89, align 4, !tbaa !8
  %109 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul540 = fmul float %108, %109
  %div541 = fdiv float 1.000000e+00, %mul540, !fpmath !12
  %mul542 = fmul float %mul533, %div541
  %add544 = add i64 %call, 584
  %arrayidx545 = getelementptr inbounds float, float* %b, i64 %add544
  %110 = load float, float* %arrayidx545, align 4, !tbaa !8
  %call546 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul542, float 0x4415AF1D80000000) #2
  %mul547 = fmul float %110, %call546
  %arrayidx550 = getelementptr inbounds float, float* %c, i64 %add544
  store float %mul547, float* %arrayidx550, align 4, !tbaa !8
  %111 = load float, float* %arrayidx5, align 4, !tbaa !8
  %112 = load float, float* %arrayidx68, align 4, !tbaa !8
  %mul557 = fmul float %111, %112
  %113 = load float, float* %arrayidx106, align 4, !tbaa !8
  %114 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul564 = fmul float %113, %114
  %div565 = fdiv float 1.000000e+00, %mul564, !fpmath !12
  %mul566 = fmul float %mul557, %div565
  %add568 = add i64 %call, 592
  %arrayidx569 = getelementptr inbounds float, float* %b, i64 %add568
  %115 = load float, float* %arrayidx569, align 4, !tbaa !8
  %call570 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul566, float 0x4415AF1D80000000) #2
  %mul571 = fmul float %115, %call570
  %arrayidx574 = getelementptr inbounds float, float* %c, i64 %add568
  store float %mul571, float* %arrayidx574, align 4, !tbaa !8
  ret void
}
