; ModuleID = './kernels/kernels/shoc-1.1.5-S3D-ratt2_kernel.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-S3D-ratt2_kernel.cl"
...
entry:
  ...
  %7 = load float, float* %arrayidx12, align 4, !tbaa !8
  %mul33 = fmul float %6, %7
  %8 = load float, float* %arrayidx5, align 4, !tbaa !8
  ...
  %11 = load float, float* %arrayidx29, align 4, !tbaa !8
  %12 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul57 = fmul float %11, %12
  %13 = load float, float* %arrayidx5, align 4, !tbaa !8
  %add62 = add i64 %call, 40
  %arrayidx63 = getelementptr inbounds float, float* %d, i64 %add62
  %14 = load float, float* %arrayidx63, align 4, !tbaa !8
  ...
  %16 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul81 = fmul float %16, %16
  %17 = load float, float* %arrayidx12, align 4, !tbaa !8
  %18 = load float, float* %arrayidx63, align 4, !tbaa !8
  ...
  %19 = load float, float* %arrayidx93, align 4, !tbaa !8
  ...
  %20 = load float, float* %arrayidx5, align 4, !tbaa !8
  %mul105 = fmul float %20, %20
  %mul106 = fmul float %mul3, %mul105
  %21 = load float, float* %arrayidx29, align 4, !tbaa !8
  %div110 = fdiv float 1.000000e+00, %21, !fpmath !12
  %mul111 = fmul float %mul106, %div110
  %arrayidx114 = getelementptr inbounds float, float* %b, i64 %add14
  %22 = load float, float* %arrayidx114, align 4, !tbaa !8
  ...
  %23 = load float, float* %arrayidx5, align 4, !tbaa !8
  %mul126 = fmul float %23, %23
  %mul127 = fmul float %mul3, %mul126
  %24 = load float, float* %arrayidx29, align 4, !tbaa !8
  %div131 = fdiv float 1.000000e+00, %24, !fpmath !12
  %mul132 = fmul float %mul127, %div131
  %arrayidx135 = getelementptr inbounds float, float* %b, i64 %add62
  %25 = load float, float* %arrayidx135, align 4, !tbaa !8
  ...
  %27 = load float, float* %arrayidx29, align 4, !tbaa !8
  %div152 = fdiv float 1.000000e+00, %27, !fpmath !12
  %mul153 = fmul float %mul148, %div152
  %add155 = add i64 %call, 48
  %arrayidx156 = getelementptr inbounds float, float* %b, i64 %add155
  %28 = load float, float* %arrayidx156, align 4, !tbaa !8
  %call157 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul153, float 0x4415AF1D80000000) #2
  %mul158 = fmul float %28, %call157
  %arrayidx161 = getelementptr inbounds float, float* %c, i64 %add155
  store float %mul158, float* %arrayidx161, align 4, !tbaa !8
  %29 = load float, float* %arrayidx5, align 4, !tbaa !8
  %mul168 = fmul float %29, %29
  %mul169 = fmul float %mul3, %mul168
  %30 = load float, float* %arrayidx29, align 4, !tbaa !8
  %div173 = fdiv float 1.000000e+00, %30, !fpmath !12
  %mul174 = fmul float %mul169, %div173
  %add176 = add i64 %call, 56
  %arrayidx177 = getelementptr inbounds float, float* %b, i64 %add176
  %31 = load float, float* %arrayidx177, align 4, !tbaa !8
  %call178 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul174, float 0x4415AF1D80000000) #2
  %mul179 = fmul float %31, %call178
  %arrayidx182 = getelementptr inbounds float, float* %c, i64 %add176
  store float %mul179, float* %arrayidx182, align 4, !tbaa !8
  %32 = load float, float* %arrayidx5, align 4, !tbaa !8
  %33 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul189 = fmul float %32, %33
  %mul190 = fmul float %mul3, %mul189
  %34 = load float, float* %arrayidx63, align 4, !tbaa !8
  %div194 = fdiv float 1.000000e+00, %34, !fpmath !12
  %mul195 = fmul float %mul190, %div194
  %add197 = add i64 %call, 64
  %arrayidx198 = getelementptr inbounds float, float* %b, i64 %add197
  %35 = load float, float* %arrayidx198, align 4, !tbaa !8
  %call199 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul195, float 0x4415AF1D80000000) #2
  %mul200 = fmul float %35, %call199
  %arrayidx203 = getelementptr inbounds float, float* %c, i64 %add197
  store float %mul200, float* %arrayidx203, align 4, !tbaa !8
  %36 = load float, float* %arrayidx5, align 4, !tbaa !8
  %37 = load float, float* %arrayidx12, align 4, !tbaa !8
  %mul210 = fmul float %36, %37
  %mul211 = fmul float %mul3, %mul210
  %38 = load float, float* %arrayidx15, align 4, !tbaa !8
  %div215 = fdiv float 1.000000e+00, %38, !fpmath !12
  %mul216 = fmul float %mul211, %div215
  %add218 = add i64 %call, 72
  %arrayidx219 = getelementptr inbounds float, float* %b, i64 %add218
  %39 = load float, float* %arrayidx219, align 4, !tbaa !8
  %call220 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul216, float 0x4415AF1D80000000) #2
  %mul221 = fmul float %39, %call220
  %arrayidx224 = getelementptr inbounds float, float* %c, i64 %add218
  store float %mul221, float* %arrayidx224, align 4, !tbaa !8
  %40 = load float, float* %arrayidx12, align 4, !tbaa !8
  %mul231 = fmul float %40, %40
  %mul232 = fmul float %mul3, %mul231
  %41 = load float, float* %arrayidx8, align 4, !tbaa !8
  %div236 = fdiv float 1.000000e+00, %41, !fpmath !12
  %mul237 = fmul float %mul232, %div236
  %add239 = add i64 %call, 80
  %arrayidx240 = getelementptr inbounds float, float* %b, i64 %add239
  %42 = load float, float* %arrayidx240, align 4, !tbaa !8
  %call241 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul237, float 0x4415AF1D80000000) #2
  %mul242 = fmul float %42, %call241
  %arrayidx245 = getelementptr inbounds float, float* %c, i64 %add239
  store float %mul242, float* %arrayidx245, align 4, !tbaa !8
  %43 = load float, float* %arrayidx5, align 4, !tbaa !8
  %44 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul252 = fmul float %43, %44
  %mul253 = fmul float %mul3, %mul252
  %arrayidx256 = getelementptr inbounds float, float* %d, i64 %add155
  %45 = load float, float* %arrayidx256, align 4, !tbaa !8
  %div257 = fdiv float 1.000000e+00, %45, !fpmath !12
  %mul258 = fmul float %mul253, %div257
  %add260 = add i64 %call, 88
  %arrayidx261 = getelementptr inbounds float, float* %b, i64 %add260
  %46 = load float, float* %arrayidx261, align 4, !tbaa !8
  %call262 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul258, float 0x4415AF1D80000000) #2
  %mul263 = fmul float %46, %call262
  %arrayidx266 = getelementptr inbounds float, float* %c, i64 %add260
  store float %mul263, float* %arrayidx266, align 4, !tbaa !8
  %47 = load float, float* %arrayidx5, align 4, !tbaa !8
  %48 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul273 = fmul float %47, %48
  %mul274 = fmul float %mul3, %mul273
  %49 = load float, float* %arrayidx256, align 4, !tbaa !8
  %div278 = fdiv float 1.000000e+00, %49, !fpmath !12
  %mul279 = fmul float %mul274, %div278
  %add281 = add i64 %call, 96
  %arrayidx282 = getelementptr inbounds float, float* %b, i64 %add281
  %50 = load float, float* %arrayidx282, align 4, !tbaa !8
  ...
  %51 = load float, float* %arrayidx5, align 4, !tbaa !8
  %52 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul294 = fmul float %51, %52
  %mul295 = fmul float %mul3, %mul294
  %53 = load float, float* %arrayidx256, align 4, !tbaa !8
  %div299 = fdiv float 1.000000e+00, %53, !fpmath !12
  %mul300 = fmul float %mul295, %div299
  %add302 = add i64 %call, 104
  %arrayidx303 = getelementptr inbounds float, float* %b, i64 %add302
  %54 = load float, float* %arrayidx303, align 4, !tbaa !8
  ...
  %55 = load float, float* %arrayidx5, align 4, !tbaa !8
  %56 = load float, float* %arrayidx8, align 4, !tbaa !8
  %mul315 = fmul float %55, %56
  %mul316 = fmul float %mul3, %mul315
  %57 = load float, float* %arrayidx256, align 4, !tbaa !8
  %div320 = fdiv float 1.000000e+00, %57, !fpmath !12
  %mul321 = fmul float %mul316, %div320
  %add323 = add i64 %call, 112
  %arrayidx324 = getelementptr inbounds float, float* %b, i64 %add323
  %58 = load float, float* %arrayidx324, align 4, !tbaa !8
  ...
  %59 = load float, float* %arrayidx15, align 4, !tbaa !8
  %mul336 = fmul float %59, %59
  %mul337 = fmul float %mul3, %mul336
  %arrayidx340 = getelementptr inbounds float, float* %d, i64 %add176
  %60 = load float, float* %arrayidx340, align 4, !tbaa !8
  %div341 = fdiv float 1.000000e+00, %60, !fpmath !12
  %mul342 = fmul float %mul337, %div341
  %add344 = add i64 %call, 120
  %arrayidx345 = getelementptr inbounds float, float* %b, i64 %add344
  %61 = load float, float* %arrayidx345, align 4, !tbaa !8
  %call346 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul342, float 0x4415AF1D80000000) #2
  %mul347 = fmul float %61, %call346
  %arrayidx350 = getelementptr inbounds float, float* %c, i64 %add344
  store float %mul347, float* %arrayidx350, align 4, !tbaa !8
  %62 = load float, float* %arrayidx5, align 4, !tbaa !8
  %63 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul357 = fmul float %62, %63
  %64 = load float, float* %arrayidx12, align 4, !tbaa !8
  %65 = load float, float* %arrayidx63, align 4, !tbaa !8
  %mul364 = fmul float %64, %65
  %div365 = fdiv float 1.000000e+00, %mul364, !fpmath !12
  %mul366 = fmul float %mul357, %div365
  %add368 = add i64 %call, 128
  %arrayidx369 = getelementptr inbounds float, float* %b, i64 %add368
  %66 = load float, float* %arrayidx369, align 4, !tbaa !8
  ...
  %67 = load float, float* %arrayidx5, align 4, !tbaa !8
  %68 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul381 = fmul float %67, %68
  %69 = load float, float* %arrayidx29, align 4, !tbaa !8
  ...
  %71 = load float, float* %arrayidx393, align 4, !tbaa !8
  ...
  %72 = load float, float* %arrayidx5, align 4, !tbaa !8
  %73 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul405 = fmul float %72, %73
  %74 = load float, float* %arrayidx15, align 4, !tbaa !8
  ...
  %75 = load float, float* %arrayidx417, align 4, !tbaa !8
  ...
  %76 = load float, float* %arrayidx12, align 4, !tbaa !8
  %77 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul429 = fmul float %76, %77
  %78 = load float, float* %arrayidx8, align 4, !tbaa !8
  ...
  %80 = load float, float* %arrayidx441, align 4, !tbaa !8
  ...
  %81 = load float, float* %arrayidx15, align 4, !tbaa !8
  %82 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul453 = fmul float %81, %82
  %83 = load float, float* %arrayidx8, align 4, !tbaa !8
  %84 = load float, float* %arrayidx63, align 4, !tbaa !8
  ...
  %85 = load float, float* %arrayidx465, align 4, !tbaa !8
  ...
  %86 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul477 = fmul float %86, %86
  %87 = load float, float* %arrayidx8, align 4, !tbaa !8
  %88 = load float, float* %arrayidx340, align 4, !tbaa !8
  %mul484 = fmul float %87, %88
  %div485 = fdiv float 1.000000e+00, %mul484, !fpmath !12
  %mul486 = fmul float %mul477, %div485
  %add488 = add i64 %call, 168
  %arrayidx489 = getelementptr inbounds float, float* %b, i64 %add488
  %89 = load float, float* %arrayidx489, align 4, !tbaa !8
  %call490 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul486, float 0x4415AF1D80000000) #2
  %mul491 = fmul float %89, %call490
  %arrayidx494 = getelementptr inbounds float, float* %c, i64 %add488
  store float %mul491, float* %arrayidx494, align 4, !tbaa !8
  %90 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul501 = fmul float %90, %90
  %91 = load float, float* %arrayidx8, align 4, !tbaa !8
  %92 = load float, float* %arrayidx340, align 4, !tbaa !8
  ...
  %93 = load float, float* %arrayidx513, align 4, !tbaa !8
  ...
  %94 = load float, float* %arrayidx5, align 4, !tbaa !8
  %95 = load float, float* %arrayidx340, align 4, !tbaa !8
  %mul525 = fmul float %94, %95
  %96 = load float, float* %arrayidx29, align 4, !tbaa !8
  %97 = load float, float* %arrayidx256, align 4, !tbaa !8
  %mul532 = fmul float %96, %97
  %div533 = fdiv float 1.000000e+00, %mul532, !fpmath !12
  %mul534 = fmul float %mul525, %div533
  %add536 = add i64 %call, 184
  %arrayidx537 = getelementptr inbounds float, float* %b, i64 %add536
  %98 = load float, float* %arrayidx537, align 4, !tbaa !8
  %call538 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul534, float 0x4415AF1D80000000) #2
  %mul539 = fmul float %98, %call538
  %arrayidx542 = getelementptr inbounds float, float* %c, i64 %add536
  store float %mul539, float* %arrayidx542, align 4, !tbaa !8
  %99 = load float, float* %arrayidx5, align 4, !tbaa !8
  %100 = load float, float* %arrayidx340, align 4, !tbaa !8
  %mul549 = fmul float %99, %100
  %101 = load float, float* %arrayidx15, align 4, !tbaa !8
  %102 = load float, float* %arrayidx63, align 4, !tbaa !8
  %mul556 = fmul float %101, %102
  %div557 = fdiv float 1.000000e+00, %mul556, !fpmath !12
  %mul558 = fmul float %mul549, %div557
  %add560 = add i64 %call, 192
  %arrayidx561 = getelementptr inbounds float, float* %b, i64 %add560
  %103 = load float, float* %arrayidx561, align 4, !tbaa !8
  %call562 = tail call float @"?fmin@@$$J0YAMMM@Z"(float %mul558, float 0x4415AF1D80000000) #2
  %mul563 = fmul float %103, %call562
  %arrayidx566 = getelementptr inbounds float, float* %c, i64 %add560
  store float %mul563, float* %arrayidx566, align 4, !tbaa !8
  ret void
}
