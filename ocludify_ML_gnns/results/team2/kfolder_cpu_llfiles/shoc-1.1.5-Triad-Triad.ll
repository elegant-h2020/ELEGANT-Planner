; ModuleID = './kernels/kernels/shoc-1.1.5-Triad-Triad.cl'
source_filename = "./kernels/kernels/shoc-1.1.5-Triad-Triad.cl"
...
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readonly %b, float* nocapture %c, float %d) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
  ...
  %arrayidx2 = getelementptr inbounds float, float* %b, i64 %idxprom
  %1 = load float, float* %arrayidx2, align 4, !tbaa !8
  %2 = tail call float @llvm.fmuladd.f32(float %d, float %1, float %0)
  %arrayidx4 = getelementptr inbounds float, float* %c, i64 %idxprom
  store float %2, float* %arrayidx4, align 4, !tbaa !8
  ret void
}
