...
"""
machine = 'gold2'
model = 'GeForceGTX_IntelXeonCPU'
exp = 'exp2'

KERNELS_FILE = 'cgo17-amd.csv'
CONFIG_FILE = 'uncompiledkernels_gold2_gpu_cpu_exp1.csv' #uncompiled kernels from experiment1
#CONFIG_FILE = 'benchmarks_config.csv'
DEVICES_FILE = f'devices_{machine}.txt'

DEFAULT_GSIZES =[100, 1000, 100] #[1000, 21000, 2000] exp1
DEFAULT_SAMPLES = 200
DEFAULT_TIMEOUTS = [10,35] #[10, 15, 20] exp1
