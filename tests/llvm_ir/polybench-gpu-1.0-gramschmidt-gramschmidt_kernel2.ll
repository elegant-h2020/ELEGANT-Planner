; ModuleID = './kernels/kernels/polybench-gpu-1.0-gramschmidt-gramschmidt_kernel2.cl'
source_filename = "./kernels/kernels/polybench-gpu-1.0-gramschmidt-gramschmidt_kernel2.cl"
...
define dso_local spir_kernel void @A(float* nocapture readonly %a, float* nocapture readonly %b, float* nocapture %c, i32 %d, i32 %e, i32 %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
if.then:                                          ; preds = %entry
  %mul = mul nsw i32 %conv, %f
  %add = add nsw i32 %mul, %d
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds float, float* %a, i64 %idxprom
  %0 = load float, float* %arrayidx, align 4, !tbaa !8
  %mul2 = mul nsw i32 %f, %d
  %add3 = add nsw i32 %mul2, %d
  %idxprom4 = sext i32 %add3 to i64
  %arrayidx5 = getelementptr inbounds float, float* %b, i64 %idxprom4
  %1 = load float, float* %arrayidx5, align 4, !tbaa !8
  %div = fdiv float %0, %1, !fpmath !12
  %arrayidx9 = getelementptr inbounds float, float* %c, i64 %idxprom
  store float %div, float* %arrayidx9, align 4, !tbaa !8
  br label %if.end
