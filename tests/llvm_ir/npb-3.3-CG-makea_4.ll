; ModuleID = './kernels/kernels/npb-3.3-CG-makea_4.cl'
source_filename = "./kernels/kernels/npb-3.3-CG-makea_4.cl"
...
define dso_local spir_kernel void @A(i32* nocapture %a, i32* nocapture %b, i32* nocapture readonly %c, i32* nocapture readonly %d, i32 %e, i32 %f) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
for.body.lver.orig.preheader:                     ; preds = %for.body.lver.check
  ...
  br i1 %lcmp.mod.not, label %for.body.lver.orig.prol.loopexit, label %for.body.lver.orig.prol
...
for.body.lver.orig.prol:                          ; preds = %for.body.lver.orig.preheader
  ...
  %9 = load i32, i32* %arrayidx11.lver.orig.prol, align 4, !tbaa !8
  ...
  %10 = load i32, i32* %arrayidx13.lver.orig.prol, align 4, !tbaa !8
  %add14.lver.orig.prol = add nsw i32 %10, %9
  store i32 %add14.lver.orig.prol, i32* %arrayidx11.lver.orig.prol, align 4, !tbaa !8
  %indvars.iv.next.lver.orig.prol = add nsw i64 %2, 2
  %11 = trunc i64 %3 to i32
  br label %for.body.lver.orig.prol.loopexit

for.body.lver.orig.prol.loopexit:                 ; preds = %for.body.lver.orig.prol, %for.body.lver.orig.preheader
...
for.body.lver.orig:                               ; preds = %for.body.lver.orig.prol.loopexit, %for.body.lver.orig
  ...
  %13 = load i32, i32* %arrayidx11.lver.orig, align 4, !tbaa !8
  ...
  %14 = load i32, i32* %arrayidx13.lver.orig, align 4, !tbaa !8
  %add14.lver.orig = add nsw i32 %14, %13
  store i32 %add14.lver.orig, i32* %arrayidx11.lver.orig, align 4, !tbaa !8
  ...
  %15 = load i32, i32* %arrayidx11.lver.orig.1, align 4, !tbaa !8
  ...
  %16 = load i32, i32* %arrayidx13.lver.orig.1, align 4, !tbaa !8
  %add14.lver.orig.1 = add nsw i32 %16, %15
  store i32 %add14.lver.orig.1, i32* %arrayidx11.lver.orig.1, align 4, !tbaa !8
  ...
  %exitcond.not.lver.orig.1 = icmp eq i32 %1, %lftr.wideiv.lver.orig.1
  br i1 %exitcond.not.lver.orig.1, label %for.cond.cleanup, label %for.body.lver.orig
...
for.body.ph:                                      ; preds = %for.body.lver.check
  ...
  br i1 %lcmp.mod53.not, label %for.body.prol.loopexit, label %for.body.prol
...
for.body.prol:                                    ; preds = %for.body.ph, %for.body.prol
  ...
  %23 = load i32, i32* %arrayidx11.prol, align 4, !tbaa !8
  %add14.prol = add nsw i32 %store_forwarded.prol, %23
  store i32 %add14.prol, i32* %arrayidx11.prol, align 4, !tbaa !8
...
if.then19:                                        ; preds = %for.cond.cleanup
  ...
  %29 = load i32, i32* %arrayidx22, align 4, !tbaa !8
  %arrayidx24 = getelementptr inbounds i32, i32* %b, i64 %idxprom
  store i32 %29, i32* %arrayidx24, align 4, !tbaa !8
  br label %cleanup
